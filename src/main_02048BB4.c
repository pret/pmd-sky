...
{
    return strncpy(dst, _020AFF38[0].field_0x0, 0x20);
}

bool8 CheckStringSave(const char *s)
{
    return strncmp(s, _020AFF38[0].field_0x0, 0x20) == 0;
}

s32 sub_02048BFC(void)
{
    return _020AFF38[0].field_0x4;
}

void sub_02048C0C(s32 v)
{
    Debug_Print0(_0209CD4C, _020AFF38[0].field_0x4, v);
    _020AFF38[0].field_0x4 = v;
}
