...
extern void TryInflictWrappedStatus(struct entity *user, struct entity *target);
...
bool8 DoMoveWrap(struct entity* attacker, struct entity* defender, struct move* move, enum item_id item_id)
{
    TryInflictWrappedStatus(attacker, defender);
