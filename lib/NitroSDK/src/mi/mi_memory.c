...
#define SP1P3_BUG_FOR_CONDITIONAL_ASM_INSTRUCTIONS

#include <nitro/code32.h>

asm void MTi_CpuClear16 (register u16 data, register void * destp, register u32 size)
{
    mov r3, #0
@00:
    cmp r3, r2
...
asm void MTi_CpuCopy16 (register const void * srcp, register void * destp, register u32 size)
{
    mov r12, #0
@10:
    cmp r12, r2
...
// asm void MTi_CpuSend16 (register const void * srcp, register volatile void * destp, register u32 size)
// {
//     mov r12, #0
// @11:
//     cmp r12, r2
...
asm void MTi_CpuClear32 (register u32 data, register void * destp, register u32 size)
{
    add r12, r1, r2
@20:
    cmp r1, r12
...
asm void MTi_CpuCopy32 (register const void * srcp, register void * destp, register u32 size)
{
    add r12, r1, r2
@30:
    cmp r1, r12
...
// asm void MTi_CpuSend32 (register const void * srcp, volatile void * destp, u32 size)
// {
//     add r12, r0, r2
// @31:
//     cmp r0, r12
...
asm void MTi_CpuClearFast (register u32 data, register void * destp, register u32 size)
{
    stmfd sp !, {r4 - r9}
    add r9, r1, r2
    mov r12, r2, lsr #5
...
asm void MTi_CpuCopy32Fast (register const void * srcp, register void * destp, register u32 size)
{
    stmfd sp !, {r4 - r10}
    add r10, r1, r2
    mov r12, r2, lsr #5
