...
NONMATCHING_SYMBOLS_ARM9 = {
    ...
    'CARD_Init': 'Card_Init',
    'CARD_InitPulledOutCallback': 'Card_InitPulledOutCallback',
    'CARDi_GetRomAccessor': 'Cardi_GetRomAccessor',
    'CARDi_InitCommon': 'Cardi_InitCommon',
    'CARDi_OnFifoRecv': 'Cardi_OnFifoRecv',
    'CARDi_PulledOutCallback': 'Cardi_PulledOutCallback',
    'CARDi_ReadCard': 'Cardi_ReadCard',
    'CARDi_ReadFromCache': 'Cardi_ReadFromCache',
    'CARDi_SetRomOp': 'Cardi_SetRomOp',
    'CARDi_TaskThread': 'Cardi_TaskThread',
    'CRYPTO_RC4Init': 'Crypto_RC4Init',
    'CTRDG_Init': 'Ctrdg_Init',
    'CTRDG_TerminateForPulledOut': 'Ctrdg_TerminateForPulledOut',
    'CTRDGi_CallbackForInitModuleInfo': 'Ctrdgi_CallbackForInitModuleInfo',
    'CTRDGi_ChangeLatestAccessCycle': 'Ctrdgi_ChangeLatestAccessCycle',
    'CTRDGi_InitCommon': 'Ctrdgi_InitCommon',
    'CTRDGi_InitModuleInfo': 'Ctrdgi_InitModuleInfo',
    'CTRDGi_LockByProcessor': 'Ctrdgi_LockByProcessor',
    'CTRDGi_PulledOutCallback': 'Ctrdgi_PulledOutCallback',
    'CTRDGi_RestoreAccessCycle': 'Ctrdgi_RestoreAccessCycle',
    'CTRDGi_SendtoPxi': 'Ctrdgi_SendtoPxi',
    'CTRDGi_UnlockByProcessor': 'Ctrdgi_UnlockByProcessor',
    'DGT_Hash2GetDigest': 'Dgt_Hash2GetDigest',
    'DGT_Hash2Reset': 'Dgt_Hash2Reset',
    'DGT_Hash2SetSource': 'Dgt_Hash2SetSource',
    'disableBankForX_': 'DisableBankForX',
    'FifoCtrlInit': 'FIFO_CTRL_INIT',
    'fsi_arc_rom': 'FSI_ARC_ROM',
    'fsi_digest_key_len': 'FSI_DIGEST_KEY_LEN',
    ...
    'MATH_CalcCRC16': 'Math_CalcCrc16',
    'MATH_CalcCRC32': 'Math_CalcCrc32',
    'MATH_CalcCRC8': 'Math_CalcCrc8',
    'MATHi_CRC16InitTable': 'Mathi_Crc16InitTable',
    'MATHi_CRC16Update': 'Mathi_Crc16Update',
    'MATHi_CRC32InitTable': 'Mathi_Crc32InitTable',
    'MATHi_CRC32Update': 'Mathi_Crc32Update',
    'MATHi_CRC8InitTable': 'Mathi_Crc8InitTable',
    'MATHi_CRC8Update': 'Mathi_Crc8Update',
    'MIi_DmaSetParams_wait_noInt': 'Mii_DmaSetParams_Wait_NoInt',
    ...
    'PXI_SendWordByFifo': 'Pxi_SendWordByFifo',
    'PXI_SetFifoRecvCallback': 'Pxi_SetFifoRecvCallback',
    'PXIi_HandlerRecvFifoNotEmpty': 'Pxii_HandlerRecvFifoNotEmpty',
    'resetBankForX_': 'EnableVramBanksInSet',
    'sCallbackTable': 'CALLBACK_TABLE',
    'sClrImg': 'CLR_IMG',
    'sDayOfYear': 'DAY_OF_YEAR',
    'sDispMode': 'DISP_MODE',
