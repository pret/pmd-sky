...
enum script_entity_id {
    ...
    ENTITY_PLAYER_BIPPA = 5,
    ENTITY_PLAYER_PUPURIN = 6,
    ENTITY_PLAYER_KIMAWARI = 7,
    ENTITY_PLAYER_FUTURE = 8,
    ENTITY_PLAYER_CHARMS = 9,
    ...
    ENTITY_ATTENDANT_BIPPA = 16,
    ENTITY_ATTENDANT_PUPURIN = 17,
    ENTITY_ATTENDANT_KIMAWARI = 18,
    ENTITY_ATTENDANT_FUTURE = 19,
    ENTITY_ATTENDANT_CHARMS = 20,
    ENTITY_ATTENDANT_MANAFI = 21,
    ENTITY_UNIT_NPC1 = 22,
    ENTITY_UNIT_NPC2 = 23,
    ENTITY_UNIT_NPC3 = 24,
    ENTITY_UNIT_NPC4 = 25,
    ...
    ENTITY_NPC_PUKURIN = 79,
    ENTITY_NPC_ZUBATTO = 80,
    ENTITY_NPC_DIGUDA = 81,
    ENTITY_NPC_DAGUTORIO = 82,
    ENTITY_NPC_MANKII = 83,
    ENTITY_NPC_OKORIZARU = 84,
    ENTITY_NPC_KOIRU = 85,
    ENTITY_NPC_SURIIPU = 86,
    ENTITY_NPC_KURABU = 87,
    ENTITY_NPC_GARAGARA = 88,
    ENTITY_NPC_DOGAASU = 89,
    ENTITY_NPC_RAKKII = 90,
    ENTITY_NPC_GARUURA = 91,
    ENTITY_NPC_GYARADOSU = 92,
    ENTITY_NPC_RAPURASU = 93,
    ENTITY_NPC_OMUSUTAA = 94,
    ENTITY_NPC_OMUSUTAA2 = 95,
    ENTITY_NPC_KABUTOPUSU = 96,
    ENTITY_NPC_NEITYIO = 97,
    ENTITY_NPC_DENRYUU = 98,
    ENTITY_NPC_MARIRU = 99,
    ENTITY_NPC_USOKKII = 100,
    ENTITY_NPC_KIMAWARI = 101,
    ENTITY_NPC_HIMEGUMA = 102,
    ENTITY_NPC_RINGUMA = 103,
    ENTITY_NPC_SEREBII = 104,
    ENTITY_NPC_JUPUTORU = 105,
    ENTITY_NPC_PERIPPAA1 = 106,
    ENTITY_NPC_PERIPPAA2 = 107,
    ENTITY_NPC_YARUKIMONO = 108,
    ENTITY_NPC_DOGOOMU = 109,
    ENTITY_NPC_RURIRI = 110,
    ENTITY_NPC_YAMIRAMI = 111,
    ENTITY_NPC_CHAAREMU = 112,
    ENTITY_NPC_KOOTASU = 113,
    ENTITY_NPC_BANEBUU = 114,
    ENTITY_NPC_HEIGANI = 115,
    ENTITY_NPC_KAKUREON1 = 116,
    ENTITY_NPC_KAKUREON2 = 117,
    ENTITY_NPC_YOMAWARU = 118,
    ENTITY_NPC_CHIRIIN = 119,
    ENTITY_NPC_REJIROKKU = 120,
    ENTITY_NPC_REJIAISU = 121,
    ENTITY_NPC_REJISUCHIRU = 122,
    ENTITY_NPC_GURAADON = 123,
    ENTITY_NPC_BIPPA = 124,
    ENTITY_NPC_RUKUSHIO1 = 125,
    ENTITY_NPC_RUKUSHIO2 = 126,
    ENTITY_NPC_RENTORAA = 127,
    ENTITY_NPC_MIMIROPPU = 128,
    ENTITY_NPC_SUKATANKU = 129,
    ENTITY_NPC_MANENE = 130,
    ENTITY_NPC_PERAPPU = 131,
    ENTITY_NPC_MIKARUGE = 132,
    ENTITY_NPC_GUREGGURU = 133,
    ENTITY_NPC_JIBAKOIRU = 134,
    ENTITY_NPC_EREKIBURU = 135,
    ENTITY_NPC_YONOWAARU = 136,
    ENTITY_NPC_YUKUSHII = 137,
    ENTITY_NPC_EMURITTO = 138,
    ENTITY_NPC_AGUNOMU = 139,
    ENTITY_NPC_DIARUGA = 140,
    ENTITY_NPC_PARUKIA = 141,
    ENTITY_NPC_REJIGIGASU = 142,
    ENTITY_NPC_GIRATYINA = 143,
    ENTITY_NPC_KURESERIA = 144,
    ENTITY_NPC_FIONE1 = 145,
    ENTITY_NPC_FIONE2 = 146,
    ENTITY_NPC_FIONE3 = 147,
    ENTITY_NPC_FIONE4 = 148,
    ENTITY_NPC_FIONE5 = 149,
    ENTITY_NPC_FIONE6 = 150,
    ENTITY_NPC_FIONE7 = 151,
    ENTITY_NPC_FIONE8 = 152,
    ENTITY_NPC_MANAFI = 153,
    ENTITY_NPC_DAAKURAI = 154,
    ENTITY_OBJECT001 = 155,
    ENTITY_OBJECT002 = 156,
    ENTITY_NPC_KOIRU2 = 157,
    ENTITY_NPC_POPPO = 158,
    ENTITY_NPC_TANEBOO = 159,
    ENTITY_NPC_OOSUBAME = 160,
    ENTITY_NPC_KEMUSSO = 161,
    ENTITY_NPC_BURAKKII = 162,
    ENTITY_NPC_KAGEBOUZU = 163,
    ENTITY_NPC_YAMIKARASU = 164,
    ENTITY_NPC_POCHIENA_A = 165,
    ENTITY_NPC_POCHIENA_B = 166,
    ENTITY_NPC_POCHIENA_C = 167,
    ENTITY_NPC_ZANGUUSU = 168,
    ENTITY_NPC_SUTORAIKU = 169,
    ENTITY_NPC_SANDOPAN = 170,
    ENTITY_NPC_PONIITA = 171,
    ENTITY_NPC_BAKUUDA = 172,
    ENTITY_NPC_MADATSUBOMI = 173,
    ENTITY_NPC_TOGEPII = 174,
    ENTITY_NPC_NYOROTONO = 175,
    ENTITY_NPC_REDIBA = 176,
    ENTITY_NPC_YADON = 177,
    ENTITY_NPC_NAMAKERO = 178,
    ENTITY_NPC_ERUREIDO = 179,
    ENTITY_NPC_ROZUREIDO = 180,
    ENTITY_NPC_DOSAIDON = 181,
    ENTITY_NPC_MANYUURA = 182,
    ENTITY_NPC_AABOKKU = 183,
    ENTITY_NPC_DORAPION = 184,
    ENTITY_NPC_BASHAAMO = 185,
    ENTITY_NPC_ENPERUTO = 186,
    ENTITY_NPC_HERAKUROSU = 187,
    ENTITY_NPC_DERUBIRU_A = 188,
    ENTITY_NPC_DERUBIRU_B = 189,
    ENTITY_NPC_DERUBIRU_C = 190,
    ENTITY_NPC_SAANAITO = 191,
    ENTITY_NPC_TODOZERUGA = 192,
    ENTITY_NPC_HASSAMU = 193,
    ENTITY_NPC_BARIYAADO = 194,
    ENTITY_NPC_FURIIZAA = 195,
    ENTITY_NPC_YUKIMENOKO = 196,
    ENTITY_NPC_RINGUMA2 = 197,
    ENTITY_NPC_YAMIRAMI2 = 198,
    ENTITY_NPC_YAMIRAMI3 = 199,
    ENTITY_NPC_YAMIRAMI4 = 200,
    ENTITY_NPC_YAMIRAMI5 = 201,
    ENTITY_NPC_YAMIRAMI6 = 202,
    ENTITY_NPC_RUKUSHIO3 = 203,
    ENTITY_NPC_RUKUSHIO4 = 204,
    ENTITY_NPC_RUKUSHIO5 = 205,
    ENTITY_NPC_RUKUSHIO6 = 206,
    ENTITY_NPC_RUKUSHIO7 = 207,
    ENTITY_NPC_RUKUSHIO8 = 208,
    ENTITY_NPC_HIIDORAN = 209,
    ENTITY_NPC_RUGIA = 210,
    ENTITY_NPC_MYUU = 211,
    ENTITY_NPC_HOUOU = 212,
    ENTITY_NPC_S_CHIRIIN = 213,
    ENTITY_NPC_S_PUKURIN = 214,
    ENTITY_NPC_S_YUKUSHII = 215,
    ENTITY_NPC_S_AGUNOMU = 216,
    ENTITY_NPC_S_EMURITTO = 217,
    ENTITY_NPC_S_KIMAWARI = 218,
    ENTITY_NPC_S_DIGUDA = 219,
    ENTITY_NPC_S_DAGUTORIO = 220,
    ENTITY_NPC_S_HEIGANI = 221,
    ENTITY_NPC_S_DOGOOMU = 222,
    ENTITY_NPC_S_BIPPA = 223,
    ENTITY_NPC_S_PERAPPU = 224,
    ENTITY_NPC_S_JUPUTORU = 225,
    ENTITY_NPC_S_YONOWAARU = 226,
    ENTITY_NPC_S_YAMIRAMI1 = 227,
    ENTITY_NPC_S_YAMIRAMI2 = 228,
    ENTITY_NPC_DARK_PUKURIN = 229,
    ENTITY_OBJ_IMAGE_REJIGIGASU = 230,
    ENTITY_NPC_DOOTAKUN1 = 231,
    ENTITY_NPC_DOOTAKUN2 = 232,
    ENTITY_NPC_DOOTAKUN3 = 233,
    ENTITY_NPC_DOOTAKUN4 = 234,
    ENTITY_NPC_DOOTAKUN5 = 235,
    ENTITY_NPC_DOOTAKUN6 = 236,
    ENTITY_OBJ_IMAGE_DOOTAKUN = 237,
    ENTITY_OBJ_IMAGE_DOOTAKUN2 = 238,
    ENTITY_OBJ_IMAGE_DOOTAKUN3 = 239,
    ENTITY_OBJ_IMAGE_DOOTAKUN4 = 240,
    ENTITY_OBJ_IMAGE_DOOTAKUN5 = 241,
    ENTITY_OBJ_IMAGE_DOOTAKUN6 = 242,
    ENTITY_NPC_SAWAMURAA1 = 243,
    ENTITY_NPC_SAWAMURAA2 = 244,
    ENTITY_NPC_SAWAMURAA3 = 245,
    ENTITY_NPC_SAWAMURAA4 = 246,
    ENTITY_NPC_SAWAMURAA5 = 247,
    ENTITY_NPC_SAWAMURAA6 = 248,
    ENTITY_OBJ_IMAGE_SAWAMURAA = 249,
    ENTITY_OBJ_IMAGE_SAWAMURAA2 = 250,
    ENTITY_OBJ_IMAGE_SAWAMURAA3 = 251,
    ENTITY_OBJ_IMAGE_SAWAMURAA4 = 252,
    ENTITY_OBJ_IMAGE_SAWAMURAA5 = 253,
    ENTITY_OBJ_IMAGE_SAWAMURAA6 = 254,
    ENTITY_NPC_DARK_DIARUGA = 255,
    ENTITY_NPC_SHADOW_DAAKURAI = 256,
    ENTITY_NPC_KURESERIA2 = 257,
    ENTITY_NPC_BOSUGODORA = 258,
    ENTITY_NPC_MAGUKARUGO = 259,
    ENTITY_NPC_BUUBAAN = 260,
    ENTITY_NPC_MUUMAAJI = 261,
    ENTITY_NPC_BARUBIITO1 = 262,
    ENTITY_NPC_BARUBIITO2 = 263,
    ENTITY_NPC_BARUBIITO3 = 264,
    ENTITY_NPC_BARUBIITO4 = 265,
    ENTITY_NPC_IRUMIIZE1 = 266,
    ENTITY_NPC_IRUMIIZE2 = 267,
    ENTITY_NPC_IRUMIIZE3 = 268,
    ENTITY_NPC_IRUMIIZE4 = 269,
    ENTITY_NPC_GABAITO = 270,
    ENTITY_NPC_REKKUUZA = 271,
    ENTITY_NPC_KAIOOGA = 272,
    ENTITY_NPC_JIRAACHI = 273,
    ENTITY_NPC_BIIDARU = 274,
    ENTITY_NPC_BIPPA_BRO = 275,
    ENTITY_NPC_BIPPA_SIS = 276,
    ENTITY_NPC_GURAIGAA = 277,
    ENTITY_NPC_TATSUBEI = 278,
    ENTITY_NPC_YUKIKABURI = 279,
    ENTITY_NPC_MANMUU = 280,
    ENTITY_NPC_ONIGOORI = 281,
    ENTITY_NPC_ONIGOORI2 = 282,
    ENTITY_NPC_ONIGOORI3 = 283,
    ENTITY_NPC_ONIGOORI4 = 284,
    ENTITY_NPC_PORIGON = 285,
    ENTITY_NPC_PORIGON2 = 286,
    ENTITY_NPC_YUKIWARASHI = 287,
    ENTITY_NPC_YUKIWARASHI2 = 288,
    ENTITY_NPC_YUKIWARASHI3 = 289,
    ENTITY_NPC_YUKIWARASHI4 = 290,
    ENTITY_NPC_JUPETTA = 291,
    ENTITY_NPC_SUKORUPI = 292,
    ENTITY_NPC_AAMARUDO = 293,
    ENTITY_NPC_PUKURIN_PAPA = 294,
    ENTITY_NPC_PUKURIN_MAMA = 295,
    ENTITY_NPC_UPAA = 296,
    ENTITY_NPC_MUCHUURU = 297,
    ENTITY_NPC_SUBOMII = 298,
    ENTITY_NPC_NIDOKINGU = 299,
    ENTITY_NPC_SOONANO = 300,
    ENTITY_NPC_SOONANSU = 301,
    ENTITY_NPC_PATCHIIRU = 302,
    ENTITY_NPC_OKUTAN = 303,
    ENTITY_NPC_TSUBOTSUBO = 304,
    ENTITY_NPC_RUNPAPPA = 305,
    ENTITY_NPC_RUNPAPPA2 = 306,
    ENTITY_NPC_RUNPAPPA3 = 307,
    ENTITY_NPC_RUNPAPPA4 = 308,
    ENTITY_NPC_RUNPAPPA5 = 309,
    ENTITY_NPC_NASSHII = 310,
    ENTITY_NPC_SHEIMI = 311,
    ENTITY_NPC_SHEIMI1 = 312,
    ENTITY_NPC_SHEIMI2 = 313,
    ENTITY_NPC_SHEIMI3 = 314,
    ENTITY_NPC_SHEIMI4 = 315,
    ENTITY_NPC_SHEIMI5 = 316,
    ENTITY_NPC_GOORIKII = 317,
    ENTITY_NPC_KINOGASSA = 318,
    ENTITY_NPC_KUCHIITO = 319,
    ENTITY_NPC_NYUURA = 320,
    ENTITY_NPC_KOIKINGU = 321,
    ENTITY_NPC_HINBASU = 322,
    ENTITY_NPC_FUWARAIDO = 323,
    ENTITY_NPC_TAMATAMA = 324,
    ENTITY_NPC_JIGUZAGUMA = 325,
    ENTITY_NPC_MASUKIPPA = 326,
    ENTITY_NPC_MASUKIPPA2 = 327,
    ENTITY_NPC_MASUKIPPA3 = 328,
    ENTITY_NPC_MASUKIPPA4 = 329,
    ENTITY_NPC_MASUKIPPA5 = 330,
    ENTITY_NPC_MASUKIPPA6 = 331,
    ENTITY_NPC_BETOBETAA = 332,
    ENTITY_NPC_BETOBETAA2 = 333,
    ENTITY_NPC_BETOBETAA3 = 334,
    ENTITY_NPC_BETOBETAA4 = 335,
    ENTITY_NPC_BETOBETAA5 = 336,
    ENTITY_NPC_BETOBETON = 337,
    ENTITY_NPC_BETOBETON2 = 338,
    ENTITY_NPC_BETOBETON3 = 339,
    ENTITY_NPC_DERIBAADO = 340,
    ENTITY_NPC_MERIIPU = 341,
    ENTITY_NPC_WATAKKO = 342,
    ENTITY_NPC_DONMERU = 343,
    ENTITY_NPC_PACHIRISU = 344,
    ENTITY_NPC_KIREIHANA = 345,
    ENTITY_NPC_KIREIHANA2 = 346,
    ENTITY_NPC_KIREIHANA3 = 347,
    ENTITY_NPC_KIREIHANA4 = 348,
    ENTITY_NPC_KODORA = 349,
    ENTITY_NPC_KODORA2 = 350,
    ENTITY_NPC_KODORA3 = 351,
    ENTITY_NPC_KODORA4 = 352,
    ENTITY_NPC_KODORA5 = 353,
    ENTITY_NPC_KODORA6 = 354,
    ENTITY_NPC_METAMON = 355,
    ENTITY_NPC_GOROON = 356,
    ENTITY_NPC_OTACHI = 357,
    ENTITY_NPC_HERUGAA = 358,
    ENTITY_NPC_NOKUTASU = 359,
    ENTITY_NPC_NOKOTCHI = 360,
    ENTITY_NPC_GOOSUTO = 361,
    ENTITY_NPC_GOOSUTO2 = 362,
    ENTITY_NPC_GOOSUTO3 = 363,
    ENTITY_NPC_MAGUMAGGU = 364,
    ENTITY_NPC_MAGUMAGGU2 = 365,
    ENTITY_NPC_SHEIMI_FC = 366,
    ENTITY_NPC_RAIBORUTO = 367,
    ENTITY_NPC_RAKURAI = 368,
    ENTITY_NPC_RAKURAI2 = 369,
    ENTITY_NPC_RAKURAI3 = 370,
    ENTITY_NPC_RAKURAI4 = 371,
    ENTITY_NPC_RAKURAI5 = 372,
    ENTITY_NPC_RAKURAI6 = 373,
    ENTITY_NPC_RAKURAI7 = 374,
    ENTITY_NPC_RAKURAI8 = 375,
    ENTITY_NPC_YONOWAARU_N8 = 376,
    ENTITY_NPC_YONOWAARU_N9 = 377,
    ENTITY_NPC_METAMON_OTACHI = 378,
    ENTITY_NPC_METAMON_KIREIHANA = 379,
    ENTITY_NPC_BIIKUIN = 380,
    ENTITY_NPC_DAINOOZU = 381,
    ENTITY_NPC_BAKUONGU = 382,
    ENTITY_NPC_NENDOORU = 383,
    ENTITY_NPC_MEGAYANMA = 384,
    ENTITY_NPC_PINPUKU = 385,
};
