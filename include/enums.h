...
#define SLEEP_STATUS_SLEEPLESS (STATUS_SLEEPLESS - STATUS_SLEEP + 1)    // 2
#define SLEEP_STATUS_NIGHTMARE (STATUS_NIGHTMARE - STATUS_SLEEP + 1)    // 3
#define SLEEP_STATUS_YAWNING (STATUS_YAWNING - STATUS_SLEEP + 1)        // 4
#define SLEEP_STATUS_NAPPING (STATUS_NAPPING - STATUS_SLEEP + 1)        // 5

#define FROZEN_STATUS_FROZEN (STATUS_FROZEN - STATUS_FROZEN + 1)        // 1
#define FROZEN_STATUS_WRAP (STATUS_WRAP - STATUS_FROZEN + 1)            // 3
