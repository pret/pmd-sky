...
DoMoveSiesta: ; 0x0232C6B4
	...
	mov r4, r1
	mov r5, r0
	ldr r1, _0232C6EC ; =ov10_022C4720
	mov r0, r4
	mov r2, #1
...
DoMoveHealingWish: ; 0x0232D298
	...
	ldr r2, _0232D2E4 ; =ov10_022C46F4
	mov ip, #1
	ldrsh r2, [r2]
	mov r3, #0
	str ip, [sp]
...
DoMoveCloseCombat: ; 0x0232D2E8
	...
	moveq r0, #0
	beq _0232D358
	ldr r0, _0232D360 ; =ov29_02352AEC
	mov r3, #1
	ldr r2, [r0]
	mov r0, r4
	mov r1, r4
	...
	ldr r0, _0232D364 ; =ov29_02352AE8
	mov r3, #1
	ldr r2, [r0]
	mov r0, r4
	mov r1, r4
...
_0232D358:
	...
	ldmia sp!, {r4, pc}
	.align 2, 0
_0232D360: .word ov29_02352AEC
_0232D364: .word ov29_02352AE8
...
DoMoveHealOrder: ; 0x0232D3D8
	stmdb sp!, {r3, lr}
	ldr r2, _0232D3FC ; =ov10_022C44B8
	mov ip, #1
	ldrsh r2, [r2]
	mov r3, #0
	str ip, [sp]
...
DoMoveThunderFang: ; 0x0232D418
	...
	moveq r0, #0
	ldmeqia sp!, {r3, r4, r5, pc}
	ldr r1, _0232D4A4 ; =ov10_022C452C
	mov r0, r5
	ldrsh r2, [r1]
	mov r1, r4
...
_0232D46C:
	ldr r1, _0232D4A8 ; =ov10_022C4678
	mov r0, r5
	ldrsh r2, [r1]
	mov r1, r4
	bl DungeonRandOutcomeUserTargetInteraction
...
_0232D49C:
	...
	ldmia sp!, {r3, r4, r5, pc}
	.align 2, 0
_0232D4A4: .word ov10_022C452C
_0232D4A8: .word ov10_022C4678
...
_0232D4FC:
	ldr r1, _0232D554 ; =ov29_02352AE8
	mov r0, r6
	ldr r2, [r1]
	mov r1, r5
	mov r3, #0
	...
	cmp r0, #6
	bne _0232D548
	ldr r1, _0232D558 ; =ov10_022C4654
...
_0232D554: .word ov29_02352AE8
_0232D558: .word ov10_022C4654
...
DoMoveIceFang: ; 0x0232D620
	...
	moveq r0, #0
	ldmeqia sp!, {r3, r4, r5, pc}
	ldr r1, _0232D6A8 ; =ov10_022C4518
	mov r0, r5
	ldrsh r2, [r1]
	mov r1, r4
	bl DungeonRandOutcomeUserTargetInteraction
...
_0232D670:
	ldr r1, _0232D6AC ; =ov10_022C453C
	mov r0, r5
	ldrsh r2, [r1]
	mov r1, r4
	bl DungeonRandOutcomeUserTargetInteraction
...
_0232D6A0:
	...
	ldmia sp!, {r3, r4, r5, pc}
	.align 2, 0
_0232D6A8: .word ov10_022C4518
_0232D6AC: .word ov10_022C453C
...
DoMoveShadowForce: ; 0x0232D860
	...
	cmp r0, #0
	beq _0232D8CC
	ldr r1, _0232D8F4 ; =ov10_022C47DC
	mov r0, r7
	ldr r3, [r1]
	mov r1, r6
	mov r2, r5
...
DoMoveChargeBeam: ; 0x0232D97C
	...
	moveq r0, #0
	ldmeqia sp!, {r3, r4, r5, pc}
	ldr r1, _0232D9DC ; =ov10_022C44F0
	mov r0, r5
	ldrsh r2, [r1]
	mov r1, r4
	bl DungeonRandOutcomeUserTargetInteraction
	cmp r0, #0
	beq _0232D9D4
	ldr r1, _0232D9E0 ; =ov29_02352AE8
	mov r0, r5
	ldr r2, [r1]
	mov r1, r5
	mov r3, #1
...
_0232D9D4:
	...
	ldmia sp!, {r3, r4, r5, pc}
	.align 2, 0
_0232D9DC: .word ov10_022C44F0
_0232D9E0: .word ov29_02352AE8
...
_0232DB7C:
	...
	cmp r0, #0
	bne _0232DBAC
	ldr r1, _0232DC4C ; =ov29_02352AEC
	mov r0, r5
	ldr r2, [r1]
	mov r1, r4
	mov r3, #2
...
_0232DBD0:
	cmp r0, #1
	bne _0232DBF4
	ldr r1, _0232DC50 ; =ov29_02352AE8
	mov r0, r5
	ldr r2, [r1]
	mov r1, r4
	mov r3, #2
...
_0232DC4C: .word ov29_02352AEC
_0232DC50: .word ov29_02352AE8
...
_0232DD10:
	cmp r0, #0
	ble _0232DD44
	ldr r1, _0232DD70 ; =ov10_022C4944
	sub r0, r0, #1
	ldr r3, [r1, r0, lsl #2]
	mov r0, r8
	mov r1, r7
...
DoMoveDamageHpDependent: ; 0x0232DE84
	...
	movgt r5, #3
_0232DF08:
	ldr r4, _0232DF34 ; =ov10_022C49B4
	str r3, [sp]
	ldr r3, [r4, r5, lsl #2]
	bl DealDamage
	cmp r0, #0
...
DoMoveRoost: ; 0x0232DFC8
	...
	mov r3, #1
	str r3, [sp]
	ldr r1, _0232E07C ; =ov10_022C4964
	mov r0, r0, lsl #1
	ldrsh r2, [r1, r0]
	mov r0, r5
	mov r1, r6
...
DoMoveFlareBlitz: ; 0x0232E130
	...
	cmp r0, #0
	beq _0232E1B4
	ldr r1, _0232E248 ; =ov10_022C4684
	mov r0, r5
	ldrsh r2, [r1]
	mov r1, r7
	bl DungeonRandOutcomeUserTargetInteraction
