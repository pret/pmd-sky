...
_02308C0C:
	...
	mov r0, #0x64
	bl DungeonRandInt
	ldr r1, _02308F90 ; =ARENA_TRAP_ACTIVATION_CHANCE
	ldrsh r1, [r1]
	cmp r0, r1
	addlt r0, r6, #0x100
...
_02308C38:
	...
	mov r0, #0x64
	bl DungeonRandInt
	ldr r1, _02308F94 ; =SHADOW_TAG_ACTIVATION_CHANCE
	ldrsh r1, [r1]
	cmp r0, r1
	bge _02308C88
	add r0, r6, #0x100
...
_02308C88:
	...
	mov r0, #0x64
	bl DungeonRandInt
	ldr r1, _02308F9C ; =MAGNET_PULL_ACTIVATION_CHANCE
	ldrsh r1, [r1]
	cmp r0, r1
	addlt r0, r6, #0x100
	ldrlth r1, [r0, #0x92 + APPLY_DAMAGE_AND_EFFECTS_OFFSET]
...
_02308F90: .word ARENA_TRAP_ACTIVATION_CHANCE
_02308F94: .word SHADOW_TAG_ACTIVATION_CHANCE
_02308F98: .word RAPID_SPIN_BINDING_REMOVAL
_02308F9C: .word MAGNET_PULL_ACTIVATION_CHANCE
