...
#define EXECUTE_MOVE_EFFECT_OFFSET_2 0
	...
	str r0, [sp, #0x30]
	ldrsh r0, [r5]
	ldr r4, _0232F7C0 ; =ACID_PSYCHIC_LOWER_DEFENSE_CHANCE
	ldrh r6, [r8, #4]
	str r0, [sp, #0x2c]
	ldrsh r0, [r4]
	ldr r2, _0232F7C4 ; =EARTH_POWER_LOWER_SPECIAL_DEFENSE_CHANCE
	ldr ip, _0232F7C8 ; =BUG_BUZZ_LOWER_SPECIAL_DEFENSE_CHANCE
	str r0, [sp, #0x28]
	ldrsh r0, [r2]
	ldr lr, _0232F7CC ; =FLASH_CANNON_LOWER_SPECIAL_DEFENSE_CHANCE
	mov sb, r1
	str r0, [sp, #0x24]
	ldrsh r0, [ip]
	str r7, [sp, #0x9c]
	...
	mov r7, r3
	str r0, [sp, #0x1c]
	ldr r0, _0232F7D4 ; =SEED_FLARE_LOWER_SPECIAL_DEFENSE_CHANCE
	ldrsh r0, [r0]
	str r0, [sp, #0x18]
	mov r0, #1
	str r0, [sp, #0x80]
...
_0232F7C0: .word ACID_PSYCHIC_LOWER_DEFENSE_CHANCE
_0232F7C4: .word EARTH_POWER_LOWER_SPECIAL_DEFENSE_CHANCE
_0232F7C8: .word BUG_BUZZ_LOWER_SPECIAL_DEFENSE_CHANCE
_0232F7CC: .word FLASH_CANNON_LOWER_SPECIAL_DEFENSE_CHANCE
_0232F7D0: .word ov29_02353718
_0232F7D4: .word SEED_FLARE_LOWER_SPECIAL_DEFENSE_CHANCE
