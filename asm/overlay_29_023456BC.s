...
RemoveGroundItem: ; 0x023456BC
	...
	ldr r1, _023457C4 ; =ov29_02353538
	ldr r2, [r1]
	ldr r1, [r2, #0x7bc]
	sub r0, r1, r0
	str r0, [r2, #0x7bc]
...
_02345770:
	mov r4, #0
	str r4, [r5, #0x10]
	ldr r5, _023457C4 ; =ov29_02353538
	mov r7, r4
	str r4, [r6]
_02345784:
	ldr r0, [r5]
...
ov29_023457C8: ; 0x023457C8
	...
	ldmeqia sp!, {r4, r5, r6, r7, r8, sb, sl, pc}
_02345830:
	ldr r0, _02345A20 ; =ov29_02353538
...
ov29_02345D84: ; 0x02345D84
	...
	mov sb, r3
	bl GetTile
	ldr r0, _02346048 ; =ov29_02353538
	mov r4, #0
	ldr r0, [r0]
...
_02346230:
	...
	movne r5, #0x67
	bne _02346310
	ldr r0, _02346340 ; =ov29_02353538
	ldr r0, [r0]
	add r5, r0, #0x348
	add r0, r5, #0x400
	bl sub_0204F7A8
...
_02346614:
	...
	bl LogMessageByIdWithPopupCheckUser
_0234662C:
	ldr r0, _023467E0 ; =ov29_02353538
	mov r6, #0
	ldr r0, [r0]
	mov fp, r6
	add r0, r0, #0x1a000
...
ov29_02346888: ; 0x02346888
	stmdb sp!, {r3, r4, lr}
	sub sp, sp, #4
	ldr r1, _023468F8 ; =ov29_02353538
	mov r0, #7
	ldr r1, [r1]
	ldrb r4, [r1, #0xc]
...
ov29_023468FC: ; 0x023468FC
	...
	mov r5, r7
	mov fp, r7
	ldr r4, _023469DC ; =ov29_02353538
	b _023469C4
_0234694C:
	ldr r0, [r4]
	add r0, r0, r7, lsl #2
...
ov29_02346A64: ; 0x02346A64
	stmdb sp!, {r3, r4, r5, r6, r7, r8, sb, sl, fp, lr}
	mov r4, #0
	ldr r5, _02346BD0 ; =ov29_02353538
	mov r7, #0x55
	mov r6, r4
_02346A78:
	ldr r0, [r5]
...
_02346C30:
	...
	mov r7, r4
	mov r8, #1
	ldr r6, _02346CB8 ; =ov29_02353538
	b _02346CA4
_02346C54:
	ldr r0, [r6]
	add r0, r0, r4, lsl #2
...
ov29_02346EBC: ; 0x02346EBC
	...
	cmp r1, #0
	bne _02346F04
	ldr r1, _02346F0C ; =ov29_02353538
	mov r3, #0
	ldr r1, [r1]
	add r1, r1, #0x3f4
	add r2, r1, #0x400
...
ov29_02346FB8: ; 0x02346FB8
	ldr r1, _02346FFC ; =ov29_02353538
	mov r3, #0
	ldr r1, [r1]
	add r1, r1, #0x56
	add r2, r1, #0x800
...
ov29_02347040: ; 0x02347040
	stmdb sp!, {r3, r4, r5, r6, r7, r8, sb, sl, fp, lr}
	mov r8, #0
	ldr r5, _023470F8 ; =ov29_02353538
...
_02347224:
	...
	cmp r1, #0
	beq _023472B4
	ldr r0, _023472C0 ; =ov29_02353538
	sub r1, r1, #1
	ldr r0, [r0]
	add r1, r1, r1, lsl #3
	add r0, r0, #0x56
...
GenerateItem: ; 0x023472C4
	...
	mov r0, #0x64
	bl DungeonRandInt
	ldr r1, _02347374 ; =ov29_02353538
	ldr r1, [r1]
	add r1, r1, #0x28000
	ldrb r1, [r1, #0x6bc]
	cmp r0, r1
...
_02347324:
	...
	cmp r0, #6
	ldmneia sp!, {r3, r4, r5, r6, r7, pc}
	ldr r0, _02347374 ; =ov29_02353538
	ldr r1, [r0]
	ldr r0, [r1, #0x7cc]
	cmp r0, #0
	add r0, r1, #0x28000
...
ov29_02347378: ; 0x02347378
	stmdb sp!, {r4, r5, r6, r7, r8, sb, sl, fp, lr}
	sub sp, sp, #0x14
	ldr r3, _02347514 ; =ov29_02353538
	mov sl, r0
	ldr r0, [r3]
	cmp r2, #0
	add r0, r0, #0x1a000
...
ov29_02347518: ; 0x02347518
	stmdb sp!, {r3, r4, r5, r6, r7, r8, sb, sl, fp, lr}
	sub sp, sp, #0x248
	ldr r4, _02347B3C ; =ov29_02353538
	mov sl, r0
	ldr r4, [r4]
	mov r6, #3
	add r0, r4, #0x1a000
