...
_022EC11C:
	...
	add r4, sl, #0x200
	ldrsh r1, [r4, #0xc2]
	ldr r0, _022EC234 ; =ov11_02324CBC
	ldrb r2, [sl, #0x2bc]
	ldr r3, [r0]
	mov r1, r1, lsl #0x14
	mov r0, #0x28
	...
	smulbb r5, r2, r0
	mov r7, r1, lsr #0x10
	ldr fp, _022EC238 ; =ov11_02320BF4
	b _022EC1E0
_022EC194:
	add r0, r7, #1
	mov r3, r0, lsl #0x10
...
_022EC1B4:
	...
	mov r3, r0, lsl #0x10
	mov r1, r7
	ldr r2, _022EC23C ; =ov11_02320BE8
	add r0, r6, r5
	mov r7, r3, lsr #0x10
	bl sub_0200A590
	add sb, sb, #1
...
_022EC21C:
	...
	ldmia sp!, {r3, r4, r5, r6, r7, r8, sb, sl, fp, pc}
	.align 2, 0
_022EC234: .word ov11_02324CBC
_022EC238: .word ov11_02320BF4
_022EC23C: .word ov11_02320BE8
