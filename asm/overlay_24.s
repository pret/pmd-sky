...
ov24_0238A140: ; 0x0238A140
	stmdb sp!, {r3, lr}
	ldr r0, _0238A60C ; =ov24_0238C600
	ldr r2, [r0]
	ldr r1, [r2]
	cmp r1, #0x26
...
_0238A250:
	bl ov11_02306C64
	ldr r1, _0238A60C ; =ov24_0238C600
	ldr r1, [r1]
	str r0, [r1, #0x1e8]
	mov r0, #0x26
	bl ov24_0238A610
...
_0238A334:
	...
	bl GetNormalMenuResult
	cmp r0, #1
	ldrne r1, _0238A60C ; =ov24_0238C600
	ldrne r1, [r1]
	strne r0, [r1, #0x1c]
	cmp r0, #1
	beq _0238A3CC
...
_0238A3DC:
	...
	ldr r2, _0238A60C ; =ov24_0238C600
	mov r1, r0
	ldr r0, [r2]
	add r0, r0, #0x42
	bl StrcpySimple
...
_0238B0CC:
	add r0, r1, #0x1bc
	bl sub_0206351C
	ldr r3, _0238B384 ; =ov24_0238C600
	mov r2, #1
	ldr r0, [r3]
	mov r1, #0
	str r2, [r0, #0x1c8]
...
_0238BEA8:
	add r0, r1, #0x1bc
	bl sub_0206351C
	ldr r3, _0238C164 ; =ov24_0238C600
	mov r2, #1
	ldr r0, [r3]
	mov r1, #0
	str r2, [r0, #0x1c8]
...
ov24_0238C1D4: ; 0x0238C1D4
	...
	mov r1, #6
	bl MemAlloc
	ldr r1, _0238C33C ; =ov24_0238C600
	mov r3, #0
	str r0, [r1]
	str r3, [r0, #0x1c]
	ldr r0, [r1]
	...
	strb r2, [r0, #0x28d]
	bl sub_0201077C
	ldr r2, _0238C33C ; =ov24_0238C600
	mov r1, r0
	ldr r0, [r2]
	add r0, r0, #0x52
	bl GetNameRaw
...
ov24_0238C4CC: ; 0x0238C4CC
	...
	mov r0, #0
	bl CreateDBox
	ldr r1, _0238C504 ; =ov24_0238C600
	ldr r1, [r1]
	strb r0, [r1, #0x28c]
	ldmia sp!, {r3, pc}
	.align 2, 0
_0238C504: .word ov24_0238C600
