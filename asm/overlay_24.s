...
ov24_0238C1D4: ; 0x0238C1D4
	...
	strb r2, [r0, #0x28d]
	bl sub_0201077C
	ldr r2, _0238C33C ; =_0238C600
	mov r1, r0
	ldr r0, [r2]
	add r0, r0, #0x52
	bl GetNameRaw
	ldr r0, _0238C33C ; =_0238C600
	ldr r1, [r0]
	add r0, r1, #0x66
	add r0, r0, #0x100
	add r1, r1, #0x52
...
ov24_0238C4CC: ; 0x0238C4CC
	...
	mov r0, #0
	bl CreateDBox
	ldr r1, _0238C504 ; =_0238C600
	ldr r1, [r1]
	strb r0, [r1, #0x28c]
	ldmia sp!, {r3, pc}
	.align 2, 0
_0238C504: .word _0238C600
