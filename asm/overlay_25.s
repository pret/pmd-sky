...
ov25_0238A140: ; 0x0238A140
	stmdb sp!, {r3, lr}
	ldr r0, _0238A67C ; =ov25_0238B5E0
	ldr r2, [r0]
	ldr r1, [r2]
	cmp r1, #0x1f
...
ov25_0238A468: ; 0x0238A468
	...
	bl GetNormalMenuResult
	cmp r0, #1
	ldrne r1, _0238A67C ; =ov25_0238B5E0
	ldrne r1, [r1]
	strne r0, [r1, #0x14]
	cmp r0, #1
	beq _0238A4E8
...
ov25_0238A694: ; 0x0238A694
	stmdb sp!, {r3, lr}
	sub sp, sp, #0x68
	ldr ip, _0238B0D0 ; =ov25_0238B5E0
	ldr r1, [ip]
	str r0, [r1]
	ldr r1, [ip]
	ldr r0, [r1]
...
_0238A734:
	...
	str r2, [r1, #0x4c]
	bl CreateDBox
	ldr r3, _0238B0D0 ; =ov25_0238B5E0
...
ov25_0238B134: ; 0x0238B134
	...
	mov r1, #6
	bl MemAlloc
	ldr r1, _0238B1C8 ; =ov25_0238B5E0
	mov r3, #0
	str r0, [r1]
	str r3, [r0, #0x14]
	ldr r0, [r1]
	...
	add r0, r0, #0x28
	bl InitPreprocessorArgs
	ldr r0, _0238B1C8 ; =ov25_0238B5E0
	mov r3, #0xb2
	ldr r2, [r0]
	mov r1, #0
	str r3, [r2, #0x74]
...
_0238B348:
	bl ov11_022E6EC8
	cmp r0, #0
	ldrne r0, _0238B37C ; =ov25_0238B5E0
	movne r1, #1
	ldrne r0, [r0]
	strne r1, [r0, #0x24]
	b _0238B374
