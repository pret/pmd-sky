...
_0238A8B8:
	...
	bl sub_02028770
	ldr r0, _0238B4F8 ; =ov13_0238CEA0
	ldr r3, _0238B50C ; =ov13_0238CF24
	ldr r7, [r0]
	mov r2, #0
	ldr r4, [r7, #0x24]
...
_0238A9A4:
	...
	bne _0238A968
	ldr r0, _0238B4F8 ; =ov13_0238CEA0
	ldr r1, _0238B514 ; =ov13_0238CECC
	mov r2, r8, lsl #3
	mov r3, #0
	ldr r0, [r0]
	strh r3, [r1, r2]
...
_0238AA28:
	...
	ldr r3, _0238B514 ; =ov13_0238CECC
	str r4, [r2, #0x18]
	mov r4, #0xa
	mov r2, #0
	str r4, [sp]
...
_0238B970:
	...
	blt _0238B910
	ldr r1, _0238B4F8 ; =ov13_0238CEA0
	ldr r0, _0238BD98 ; =ov13_0238CEBC
	ldr r2, [r1]
