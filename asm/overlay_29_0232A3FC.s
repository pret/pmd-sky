...
DoMoveRest: ; 0x0232A414
	...
	b _0232A474
_0232A454:
	ldr r1, _0232A47C ; =ov10_022C4748
	mov r0, r4
	mov r2, #0
...
DoMoveSuperpower: ; 0x0232A524
	...
	cmp r4, #0
	beq _0232A59C
	ldr r0, _0232A5A8 ; =ov29_02352AEC
	mov ip, #0
	ldr r2, [r0]
	str ip, [sp]
	mov r0, r5
...
DoMoveSteelWing: ; 0x0232A5AC
	...
	cmp r0, #0
	beq _0232A628
	ldr r1, _0232A63C ; =ov10_022C44C4
	mov r0, r6
	ldrsh r2, [r1]
	mov r1, r5
	mov r4, #1
...
DoMoveBellyDrum: ; 0x0232AC54
	...
	cmp r0, #1
	ble _0232ACD8
	ldr r1, _0232AD00 ; =ov29_02352AEC
	mov r0, r7
	ldr r2, [r1]
	mov r1, r6
	mov r3, #0x63
...
DoMoveSecretPower: ; 0x0232AD18
	...
	cmp r0, #0
	beq _0232AED0
	ldr r1, _0232AEDC ; =ov10_022C454C
	mov r0, r6
	ldrsh r2, [r1]
	mov r1, r5
	mov r4, #1
...
_0232ADB4:
	...
	b _0232AED0
_0232ADCC:
	ldr r1, _0232AEE8 ; =ov10_022C4720
	mov r0, r5
	mov r2, r4
	bl CalcStatusDuration
	mov r2, r0
...
_0232ADF4:
	...
	b _0232AED0
_0232AE0C:
	ldr r0, _0232AEEC ; =ov29_02352AEC
	mov r3, r4
	ldr r2, [r0]
	mov r1, r5
	mov r0, r6
...
_0232AE34:
	...
	b _0232AED0
_0232AE5C:
	ldr r1, _0232AEEC ; =ov29_02352AEC
	mov r0, r6
	ldr r2, [r1]
	mov r1, r5
	mov r3, #0
...
_0232AED0:
	...
	.align 2, 0
_0232AEDC: .word ov10_022C454C
_0232AEE0: .word ov29_02353538
_0232AEE4: .word ov10_022C6321
_0232AEE8: .word ov10_022C4720
_0232AEEC: .word ov29_02352AEC
...
DoMoveDamageConfuse30: ; 0x0232AEF0
	...
	cmp r0, #0
	beq _0232AF4C
	ldr r1, _0232AF58 ; =ov10_022C4548
	mov r0, r6
	ldrsh r2, [r1]
	mov r1, r5
	mov r4, #1
...
DoMovePause: ; 0x0232AFA0
	...
	mov r4, r1
	mov r5, r0
	ldr r1, _0232AFEC ; =ov10_022C471C
	mov r0, r4
	mov r2, #1
	bl CalcStatusDuration
	mov r2, #1
...
DoMoveFeatherDance: ; 0x0232AFF0
	stmdb sp!, {r3, lr}
	sub sp, sp, #8
	ldr r2, _0232B020 ; =ov29_02352AEC
	mov ip, #1
	ldr r2, [r2]
	str ip, [sp]
	mov r3, #2
...
DoMoveCrushClaw: ; 0x0232B164
	...
	cmp r0, #0
	beq _0232B1D0
	ldr r1, _0232B1DC ; =ov10_022C4608
	mov r0, r6
	ldrsh r2, [r1]
	mov r1, r5
	mov r4, #1
	...
	cmp r0, #0
	beq _0232B1D0
	ldr r0, _0232B1E0 ; =ov29_02352AEC
	mov r3, r4
	ldr r2, [r0]
	mov r0, r6
	mov r1, r5
...
_0232B1D0:
	...
	ldmia sp!, {r4, r5, r6, pc}
	.align 2, 0
_0232B1DC: .word ov10_022C4608
_0232B1E0: .word ov29_02352AEC
...
DoMoveBlazeKick: ; 0x0232B1E4
	...
	cmp r0, #0
	beq _0232B25C
	ldr r1, _0232B268 ; =ov10_022C4540
	mov r0, r8
	ldrsh r2, [r1]
	mov r1, r7
	mov r4, #1
...
DoMoveEruption: ; 0x0232B368
	...
	movgt r2, #3
_0232B3FC:
	ldr r1, _0232B430 ; =ov10_022C49C4
	mov r0, r7
	ldr r3, [r1, r2, lsl #2]
	mov r1, r6
	mov r2, r5
...
DoMovePoisonTail: ; 0x0232B494
	...
	cmp r0, #0
	beq _0232B4F0
	ldr r1, _0232B4FC ; =ov10_022C448C
	mov r0, r6
	ldrsh r2, [r1]
	mov r1, r5
	mov r4, #1
...
DoMoveTailGlow: ; 0x0232B5C8
	stmdb sp!, {r3, lr}
	ldr r2, _0232B5E4 ; =ov29_02352AE8
	mov r3, #2
	ldr r2, [r2]
	bl BoostOffensiveStat
	mov r0, #1
...
_0232B640:
	...
	cmp r0, #0
	beq _0232B694
	ldr r1, _0232B6A0 ; =ov10_022C44A4
	mov r0, r7
	ldrsh r2, [r1]
	mov r1, r6
	mov r8, #1
...
DoMoveDefenseCurl: ; 0x0232B7E0
	stmdb sp!, {r3, lr}
	ldr r2, _0232B7FC ; =ov29_02352AEC
	mov r3, #1
	ldr r2, [r2]
	bl BoostDefensiveStat
	mov r0, #1
...
DoMoveMistBall: ; 0x0232B820
	...
	cmp r0, #0
	beq _0232B88C
	ldr r1, _0232B898 ; =ov10_022C44E0
	mov r0, r6
	ldrsh r2, [r1]
	mov r1, r5
	mov r4, #1
	...
	cmp r0, #0
	beq _0232B88C
	ldr r0, _0232B89C ; =ov29_02352AE8
	mov r3, r4
	ldr r2, [r0]
	mov r0, r6
	mov r1, r5
...
_0232B88C:
	...
	ldmia sp!, {r4, r5, r6, pc}
	.align 2, 0
_0232B898: .word ov10_022C44E0
_0232B89C: .word ov29_02352AE8
...
DoMoveCalmMind: ; 0x0232B8E4
	stmdb sp!, {r3, r4, r5, lr}
	ldr r2, _0232B924 ; =ov29_02352AE8
	mov r3, #1
	ldr r2, [r2]
	mov r5, r0
	mov r4, r1
...
DoMoveMetalClaw: ; 0x0232B940
	...
	cmp r0, #0
	beq _0232B9B8
	ldr r1, _0232B9CC ; =ov10_022C4554
	mov r0, r6
	ldrsh r2, [r1]
	mov r1, r6
	mov r4, #1
...
DoMoveMetronome: ; 0x0232BC64
	...
	mov r5, r0
	ldr r6, [r2]
	ldr r0, _0232BCBC ; =ov10_022C5DDC
	mov r2, r6, lsl #3
	mov r4, r1
	ldrh r1, [r0, r2]
	add r0, sp, #0
...
DoMoveDragonRage: ; 0x0232BF88
	...
	str r3, [sp, #0x14]
	str r2, [sp, #0x18]
	ldr r2, _0232C024 ; =ov10_022C46D4
	mov r1, r8
	ldrsh r2, [r2]
	mov r0, r4
	bl CalcDamageFixedWrapper
...
DoMoveSkullBash: ; 0x0232C064
	...
	cmp r0, #0
	beq _0232C0C0
	ldr r1, _0232C0EC ; =ov10_022C48BC
	mov r0, r7
	ldr r3, [r1]
	mov r1, r6
	mov r2, r5
...
_0232C128:
	...
	cmp r0, #0
	beq _0232C18C
	ldr r1, _0232C19C ; =ov10_022C450C
	mov r0, r5
	ldrsh r2, [r1]
	mov r1, r4
	mov r6, #1
	...
	cmp r0, #0
	beq _0232C18C
	ldr r0, _0232C1A0 ; =ov29_02352AE8
	mov r3, r6
	ldr r2, [r0]
	mov r1, r4
	mov r0, r5
...
_0232C19C: .word ov10_022C450C
_0232C1A0: .word ov29_02352AE8
