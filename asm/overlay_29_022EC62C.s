...
ov29_022EC62C: ; 0x022EC62C
	...
	ldr r7, _022EC6D8 ; =ov29_02353538
	ldr r1, [r7]
	ldrb r0, [r1, #0x10]
	cmp r0, #0
...
TrySpawnMonsterAndActivatePlusMinus: ; 0x022EC6DC
	...
	ldr r0, _022EC7E0 ; =ov29_02353538
	...
	ldr r4, _022EC7E0 ; =ov29_02353538
	mov r8, #0
	ldr r0, [r4]
	mov fp, #1
	add r0, r0, #0x3000
...
IsFloorOver: ; 0x022EC7E8
	stmdb sp!, {r3, lr}
	ldr r0, _022EC858 ; =ov29_02353538
	ldr r0, [r0]
	ldrb r0, [r0, #8]
	cmp r0, #0
	movne r0, #1
	...
	bl GetLeader
	cmp r0, #0
	ldreq r1, _022EC858 ; =ov29_02353538
	moveq r0, #1
	ldreq r1, [r1]
	streqb r0, [r1, #0x758]
	ldmeqia sp!, {r3, pc}
...
_022EC8F0:
	strb r4, [r6, #3]
	mov r8, #0x63
	ldr r7, _022EC99C ; =ov29_02353538
	b _022EC93C
_022EC900:
	ldrb r1, [r6, #3]
	mov r0, r8
...
_022EC96C:
	...
	cmp r0, #0
	bne _022EC8F0
	ldr r0, _022EC99C ; =ov29_02353538
	mov r2, #0
	ldr r0, [r0]
...
_022ECB70:
	cmp r0, #0
	ldmeqia sp!, {r4, pc}
	ldr r0, _022ECD7C ; =ov29_02353538
	ldr r0, [r0]
	add r0, r0, #0x700
	ldrsh r1, [r0, #0x84]
	cmp r1, #0
	...
	cmp r0, #0
	ldmneia sp!, {r4, pc}
	ldr r1, _022ECD7C ; =ov29_02353538
	mov r0, r4
	ldr r2, [r1]
	add r1, r2, #0x4000
	ldrsh r1, [r1, #0xd4]
