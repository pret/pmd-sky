...
_02312260:
	...
	cmp r0, #7
	beq _02312300
	ldr r1, _0231232C ; =INFATUATED_TURN_RANGE
	mov r3, #7
	mov r0, r4
	mov r2, #1
	strb r3, [r6, #0xd0]
...
_0231232C: .word INFATUATED_TURN_RANGE
...
_0231247C:
	...
	cmp r0, #1
	beq _023124F4
	ldr r1, _02312604 ; =BURN_TURN_RANGE
	mov r0, sb
	mov r2, r5
	strb r5, [r7, #0xbf]
	bl CalcStatusDuration
...
_02312604: .word BURN_TURN_RANGE
...
_02312798:
	...
	cmp r0, #2
	beq _0231281C
	ldr r1, _0231292C ; =POISONED_TURN_RANGE
	mov r3, #2
	mov r0, sb
	mov r2, r4
	strb r3, [r7, #0xbf]
...
_0231292C: .word POISONED_TURN_RANGE
...
_02312A70:
	...
	cmp r0, #3
	beq _02312AEC
	ldr r1, _02312BE8 ; =BADLY_POISONED_TURN_RANGE
	mov r3, #3
	mov r0, sb
	mov r2, r4
	strb r3, [r7, #0xbf]
...
_02312BE8: .word BADLY_POISONED_TURN_RANGE
...
_02312D88:
	...
	bl ov29_022E4C4C
	mov r2, #1
	ldr r1, _02312E14 ; =FROZEN_TURN_RANGE
	mov r0, r6
	strb r2, [r4, #0xc4]
	bl CalcStatusDuration
	add r3, r0, #1
...
_02312E14: .word FROZEN_TURN_RANGE
...
_02312ECC:
	...
	cmp r0, #7
	beq _02312F48
	ldr r1, _02312F6C ; =CONSTRICTION_TURN_RANGE
	mov r3, #7
	mov r0, r6
	mov r2, #1
	strb r3, [r4, #0xc4]
...
_02312F6C: .word CONSTRICTION_TURN_RANGE
...
_023134E0:
	...
	cmp r0, #0
	beq _02313524
	ldr r1, _023135E8 ; =PLAYER_PETRIFIED_TURN_RANGE
	mov r0, r5
	bl CalcStatusDuration
	b _02313530
_02313524:
	ldr r1, _023135EC ; =PETRIFIED_TURN_RANGE
	mov r0, r5
	bl CalcStatusDuration
_02313530:
	add r0, r0, #1
...
_023135DC:
	...
	ldmia sp!, {r3, r4, r5, r6, r7, r8, sb, pc}
	.align 2, 0
_023135E8: .word PLAYER_PETRIFIED_TURN_RANGE
_023135EC: .word PETRIFIED_TURN_RANGE
#ifdef JAPAN
