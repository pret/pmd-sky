...
ov29_02302CC8: ; 0x02302CC8
	...
	b _02302D58
_02302D40:
	ldr r0, _02302F64 ; =ov29_02353538
	ldr r0, [r0]
	ldrb r0, [r0, #0x748]
...
ov29_02303F18: ; 0x02303F18
	...
	sub sp, sp, #0x38
	ldr r1, _023046C8 ; =ov29_02353538
	mov r7, r0
	ldr r0, [r1]
	ldr r5, [r7, #0xb4]
	add r0, r0, #0x1a000
...
_02304590:
	...
	strh r2, [r1, #0x82]
	ldrsh r8, [r7, #0x52]
	ldr r3, _023046C8 ; =ov29_02353538
	add r2, r0, #2
	strh r8, [r1, #0x84]
	ldrsh sb, [r1, #0x82]
	ldr r8, [r7, #0xc]
...
_0230464C:
	...
	cmpne r0, #6
	beq _023046C0
	ldr r0, _023046C8 ; =ov29_02353538
	ldr r0, [r0]
	ldrb r0, [r0, #0x78b]
	cmp r0, #0
	beq _02304690
...
ov29_0230473C: ; 0x0230473C
	...
	mov r5, #0
	ldr r6, _023047B4 ; =ov29_02353538
	mov r7, r5
_0230474C:
	ldr r0, [r6]
	add r0, r0, r5, lsl #2
