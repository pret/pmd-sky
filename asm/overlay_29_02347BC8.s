...
ov29_02347BC8: ; 0x02347BC8
	...
	sub sp, sp, #0x44
	ldr r4, _0234800C ; =ov29_02353538
	mov sl, r0
	ldr r4, [r4]
	mov r6, #3
	add r0, r4, #0x1a000
...
ov29_023482D4: ; 0x023482D4
	...
	ldr r1, _02348308 ; =ov29_02353538
	mov r5, r0
	ldr r4, [r1]
	bl ov29_023386B0
	mov r3, r0
...
ov29_023484A0: ; 0x023484A0
	...
	ldr r0, _02348804 ; =ov29_02353538
	ldr r0, [r0]
	add r0, r0, #0x348
	add r7, r0, #0x400
	add r0, r7, #0x18
	...
	mov r5, #3
	mov r6, #1
	ldr r4, _02348804 ; =ov29_02353538
	b _02348798
_023484FC:
	mov r0, r7
	mov r1, r8
...
_023487D4:
	ldr r1, _02348804 ; =ov29_02353538
	ldrb r2, [r4, #0x776]
	ldr r0, [r1]
	add r0, r0, #0x4000
	strb r2, [r0, #0xda]
...
ov29_02348850: ; 0x02348850
	stmdb sp!, {r3, lr}
	ldr r0, _02348884 ; =ov29_02353538
	ldr r1, [r0]
	ldrb r0, [r1, #0x760]
	cmp r0, #0
	ldmeqia sp!, {r3, pc}
	...
	add r0, r0, #0x400
	bl ov29_0234880C
	ldr r1, _02348884 ; =ov29_02353538
	ldr r1, [r1]
	strb r0, [r1, #0x763]
	ldmia sp!, {r3, pc}
	.align 2, 0
_02348884: .word ov29_02353538
...
ov29_02348918: ; 0x02348918
	stmdb sp!, {r4, r5, r6, lr}
	ldr r0, _02348990 ; =ov29_02353538
	ldr r0, [r0]
	add r5, r0, #0x348
...
ov29_02348ABC: ; 0x02348ABC
	...
	mov r0, #1
	bl ov29_02344B9C
	ldr r1, _02348B20 ; =ov29_02353538
	...
	mov r0, #0
	bl ov29_02349AD4
	ldr r0, _02348B20 ; =ov29_02353538
	mov r1, #1
	ldr r0, [r0]
	strb r1, [r0, #0x77a]
	ldmia sp!, {r3, pc}
	.align 2, 0
_02348B20: .word ov29_02353538
...
ov29_02348B28: ; 0x02348B28
	stmdb sp!, {r4, lr}
	ldr r1, _02348B94 ; =ov29_02353538
	mov r4, r0
	ldr r1, [r1]
	mov r0, #0
	add r1, r1, #0x700
	...
	bl ov29_02348A18
	mov r1, #1
	ldr r0, _02348B94 ; =ov29_02353538
	ldr r0, [r0]
	strb r1, [r0, #0x77a]
	ldmia sp!, {r4, pc}
	.align 2, 0
_02348B94: .word ov29_02353538
...
ov29_02348C64: ; 0x02348C64
	stmdb sp!, {r4, r5, r6, lr}
	sub sp, sp, #0x40
	ldr r1, _02348CFC ; =ov29_02353538
	mov r5, r0
	ldr r0, [r1]
	mov r4, #0
	add r6, r0, #0x348
...
_02348D78:
	...
	b _02348DCC
_02348DA8:
	ldr r0, _02348DD4 ; =ov29_02353538
	ldr r0, [r0]
	ldrb r0, [r0, #0x777]
	cmp r0, #0
	beq _02348DCC
...
ov29_02348F20: ; 0x02348F20
	...
	cmp r0, #0
	ldrne r0, _02348FD4 ; =ov29_02353538
	ldrne r0, [r0]
	ldrneb r0, [r0, #1]
	cmpne r0, #0
	beq _02348FCC
	...
	cmp r0, #0
	beq _02348F68
	ldr r0, _02348FD4 ; =ov29_02353538
	ldr r0, [r0]
	add r0, r0, #0x700
	ldrsh r0, [r0, #0x6e]
	bl ov29_0234A790
...
ov29_02348FD8: ; 0x02348FD8
	...
	cmp r0, #0
	beq _02349014
	ldr r0, _02349088 ; =ov29_02353538
	ldr r0, [r0]
	ldrb r0, [r0, #0x77a]
	cmp r0, #0
	bne _02349014
...
ov29_0234908C: ; 0x0234908C
	...
	cmp r0, #0
	beq _023490CC
	ldr r0, _02349148 ; =ov29_02353538
	ldr r0, [r0]
	ldrb r0, [r0, #0x77a]
	cmp r0, #0
	bne _023490CC
...
GetMissionDestination: ; 0x023491A4
	ldr r0, _023491B4 ; =ov29_02353538
	ldr r0, [r0]
	add r0, r0, #0x760
	bx lr
	.align 2, 0
_023491B4: .word ov29_02353538
...
IsLegendaryChallengeFloor: ; 0x023492D4
	...
	cmp r0, #0
	beq _02349308
	ldr r0, _02349310 ; =ov29_02353538
	ldr r0, [r0]
	ldrb r0, [r0, #0x762]
	add r0, r0, #0xff
	and r0, r0, #0xff
...
IsJirachiChallengeFloor: ; 0x02349314
	...
	cmp r0, #0
	beq _02349340
	ldr r0, _02349348 ; =ov29_02353538
	ldr r0, [r0]
	ldrb r0, [r0, #0x762]
	cmp r0, #5
	moveq r0, #1
...
SetMissionTargetEnemyDefeated: ; 0x02349490
	ldr r1, _023494A0 ; =ov29_02353538
	ldr r1, [r1]
	strb r0, [r1, #0x77b]
	bx lr
	.align 2, 0
_023494A0: .word ov29_02353538
...
IsDestinationFloorWithFixedRoom: ; 0x023494A4
	ldr r0, _023494C8 ; =ov29_02353538
	ldr r1, [r0]
	ldrb r0, [r1, #0x760]
	cmp r0, #0
	ldrneb r0, [r1, #0x776]
...
GetTargetMonsterNotFoundFlag: ; 0x023496D8
	ldr r0, _023496E8 ; =ov29_02353538
	ldr r0, [r0]
	ldrb r0, [r0, #3]
	bx lr
	.align 2, 0
_023496E8: .word ov29_02353538
