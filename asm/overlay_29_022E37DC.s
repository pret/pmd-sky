...
AnimationDelayOrSomething: ; 0x022E38E0
	...
	ldr r1, _022E3A38 ; =ov29_02353538
	mov r7, #0
	ldr r2, [r1]
	mov r1, r7
	add r2, r2, #0x1a000
...
ov29_022E3A58: ; 0x022E3A58
	stmdb sp!, {r4, r5, r6, r7, r8, lr}
	ldr r6, _022E3AB0 ; =ov29_02353538
	mov r5, r0
	mov r4, #0
	mov r7, #1
_022E3A6C:
...
_022E3B1C:
	...
	orrlt r1, r1, #0x2000
_022E3D00:
	ldr r3, _022E3DD4 ; =ov29_02353538
	ldr r3, [r3]
	ldrb r3, [r3, #0x78d]
	cmp r3, #0
	beq _022E3D30
...
ov29_022E5478: ; 0x022E5478
	stmdb sp!, {r4, lr}
	sub sp, sp, #0x10
	ldr r2, _022E5508 ; =ov29_02353538
	mov r4, r0
	ldr r2, [r2]
	ldr r0, [r1, #8]
	ldrb r1, [r2, #0x1c5]
...
ov29_022E5A00: ; 0x022E5A00
	...
	ldreqsh r4, [r4, #4]
	mov r1, r1, asr #8
	ldr r0, _022E5ADC ; =ov29_02353538
	strh r1, [sp, #4]
	ldr r2, [r5, #0x10]
	ldr r1, [r0]
	mov r0, r2, asr #8
...
ov29_022E5AE4: ; 0x022E5AE4
	...
	ldreqsh r4, [r4, #4]
	mov r1, r1, asr #8
	ldr r0, _022E5BD0 ; =ov29_02353538
	strh r1, [sp, #4]
	ldr r2, [r5, #0x10]
	ldr r1, [r0]
	mov r0, r2, asr #8
...
ov29_022E5BD8: ; 0x022E5BD8
	...
	ldrb r4, [r1, #0x4c]
	mov r1, r0, asr #8
	ldr r0, _022E5D58 ; =ov29_02353538
	strh r1, [sp, #0x10]
	ldr r2, [r5, #0x10]
	ldr r1, [r0]
	mov r0, r2, asr #8
	...
	ldrsh r8, [sp, #0xc]
	ldrsh r7, [sp, #0xe]
	ldr r4, _022E5D58 ; =ov29_02353538
...
ov29_022E5D68: ; 0x022E5D68
	...
	beq _022E5DA4
_022E5D88:
	ldr r0, _022E5DB0 ; =ov29_02353538
	ldr r0, [r0]
	ldrb r0, [r0, #0x748]
	bl DungeonGoesUp
	cmp r0, #0
...
ov29_022E5ED0: ; 0x022E5ED0
	...
	moveq r0, #0
	ldmeqia sp!, {r3, pc}
	ldr r1, _022E5F1C ; =ov29_02353538
	ldr r1, [r1]
	add r1, r1, #0x1a000
	ldrb r2, [r1, #0x23e]
	cmp r2, #0
...
ov29_022E5F20: ; 0x022E5F20
	...
	mov r8, #0
	ldr fp, _022E5FE0 ; =ov29_02353538
	rsb r4, r0, #0x198
	mov r7, r8
	mov r6, #2
	mov r5, r8
...
ov29_022E5FE8: ; 0x022E5FE8
	...
	sub sp, sp, #0x10
	ldr r2, _022E60D4 ; =ov29_02353538
	mov r6, r0
	ldr r0, [r2]
	mov r5, r1
	add r0, r0, #0x1a000
...
ov29_022E67E4: ; 0x022E67E4
	...
	bl ov29_022EA370
	mov r4, #0x42
	ldr sb, _022E68B4 ; =ov29_02353538
...
ov29_022E6D68: ; 0x022E6D68
	stmdb sp!, {r3, r4, r5, lr}
	ldr r3, _022E6DCC ; =ov29_02353538
	mov r4, #0
	ldr r3, [r3]
	add r3, r3, #0x218
	add lr, r3, #0x400
...
ov29_022E6DD0: ; 0x022E6DD0
	...
	mov sb, #0
	ldr r4, _022E6E3C ; =ov29_02353538
	mov r7, sb
	mov r8, #1
	mvn r6, #0
	mov r5, sb
...
ov29_022E6E80: ; 0x022E6E80
	...
	str r0, [sp, #8]
_022E6ED0:
	ldr r0, _022E6F90 ; =ov29_02353538
	ldr r0, [r0]
	add r0, r0, #0x218
	add r0, r0, #0x400
	add r8, r0, r7, lsl #4
...
LoadMappaFileAttributes: ; 0x022E6FBC
	stmdb sp!, {r3, r4, r5, r6, r7, r8, sb, sl, fp, lr}
	sub sp, sp, #0x50
	ldr r3, _022E79E4 ; =ov29_02353538
	...
	ldr r1, _022E79E4 ; =ov29_02353538
	ldr r3, [r1]
	ldrb r2, [r3, #0x74a]
	add r0, r3, #0x28000
	strb r2, [r0, #0x6b0]
...
_022E709C:
	...
	ldr sb, [sp, #0x28]
	bl AdvanceFrame
	ldr r0, _022E79E4 ; =ov29_02353538
	ldr r6, [sb]
	ldr r7, [r0]
	mov r1, #0x12
	add r0, r7, #0x28000
	...
	ldr r2, _022E79E4 ; =ov29_02353538
	ldr r1, [r2]
	add r1, r1, #0x2c000
	strb r0, [r1, #0xaf4]
	ldr r0, [r2]
...
_022E73B0:
	...
	cmp r0, #0
	ldreq r0, _022E79E4 ; =ov29_02353538
	ldreq r0, [r0]
	addeq r0, r0, #0x700
	streqh r8, [r0, #0xa8]
	beq _022E73E4
...
_022E75EC:
	...
	ldr r3, _022E79E4 ; =ov29_02353538
	cmp r2, r0
	ldrne r1, _022E79E4 ; =ov29_02353538
...
_022E77D4:
	...
	add r8, r8, r0
_022E782C:
	ldr r4, _022E79E4 ; =ov29_02353538
...
_022E7908:
	...
	mul r1, r4, r1
	mov r2, #0
	ldr r7, _022E79E4 ; =ov29_02353538
...
ov29_022E7A30: ; 0x022E7A30
	...
	bl DungeonRandInt
	ldr r1, _022E7A84 ; =ov29_02353538
	mov r3, #0
	ldr ip, [r1]
...
GetItemIdToSpawn: ; 0x022E7AC4
	...
	mov r1, #0xb10
	mul r5, r4, r1
	ldr r2, _022E7BAC ; =ov29_02353538
	mov r4, #0x10
	ldr r1, [r2]
	mov r3, #0
	add r6, r1, r5
...
_022E7B20:
	...
	mov r6, r0
	mov r7, #0
	ldr sb, _022E7BAC ; =ov29_02353538
...
ov29_022E7BE8: ; 0x022E7BE8
	...
	mov r5, r1
	mov r4, #0
	ldr r7, _022E7C5C ; =ov29_02353538
	b _022E7C4C
_022E7C00:
	ldr r0, [r7]
	add r0, r0, #0x164
...
MonsterSpawnListPartialCopy: ; 0x022E7C60
	...
	b _022E7CE4
_022E7C74:
	ldr r0, _022E7CF4 ; =ov29_02353538
	ldr r0, [r0]
	add r0, r0, #0x164
	add r0, r0, #0x2c800
	add r0, r0, r4, lsl #3
	...
	cmp r0, #6
	bhi _022E7CE0
	ldr r1, _022E7CF4 ; =ov29_02353538
...
ov29_022E7CFC: ; 0x022E7CFC
	stmdb sp!, {r3, lr}
	ldr r1, _022E7D48 ; =ov29_02353538
	ldr r0, [r1]
	add r0, r0, #0x3000
	ldrb r2, [r0, #0xe28]
	cmp r2, #0
...
IsOnMonsterSpawnList: ; 0x022E7D4C
	...
	mov r6, r0
	mov r5, #0
	ldr r4, _022E7D9C ; =ov29_02353538
	b _022E7D8C
_022E7D60:
	ldr r0, [r4]
	add r0, r0, #0x164
...
GetMonsterIdToSpawn: ; 0x022E7DA0
	...
	bl DungeonRandInt
	ldr r1, _022E7E54 ; =ov29_02353538
	mov ip, #0
	ldr r1, [r1]
	add r2, r1, #0x3000
	ldr lr, [r2, #0xe20]
...
GetMonsterLevelToSpawn: ; 0x022E7E58
	...
	mov r5, r0
	mov r4, #0
	ldr r6, _022E7EC0 ; =ov29_02353538
	b _022E7EA4
_022E7E6C:
	add r0, r1, #0x174
	add r0, r0, #0x3800
	...
	cmp r5, r0
	bne _022E7EA0
	ldr r0, _022E7EC0 ; =ov29_02353538
	ldr r0, [r0]
	add r0, r0, #0x174
	add r0, r0, #0x3800
	add r0, r0, r4, lsl #3
...
ov29_022E8270: ; 0x022E8270
	...
	ldr r1, _022E8400 ; =ov29_02353538
	mov r4, r0
	ldr r1, [r1]
	mov r5, #0
	add r1, r1, #0x1a000
...
_022E82F0:
	...
	cmpne r0, #6
	beq _022E8364
	ldr r0, _022E8400 ; =ov29_02353538
	ldr r0, [r0]
	ldrb r0, [r0, #0x78b]
	cmp r0, #0
	beq _022E832C
...
_022E83A4:
	ldrb r0, [r8, #0xef]
	cmp r0, #1
	ldreq r0, _022E8400 ; =ov29_02353538
	ldreq r0, [r0]
	addeq r0, r0, #0x1a000
	ldreqb r0, [r0, #0x244]
	cmpeq r0, #0
...
ov29_022E8CE8: ; 0x022E8CE8
	...
	mov r8, sb
_022E8CFC:
	ldr r0, _022E8E58 ; =ov29_02353538
	ldr r1, [r0]
	add r0, r1, r8, lsl #2
	add r0, r0, #0x12000
	ldr r0, [r0, #0xb28]
...
ov29_022E8FCC: ; 0x022E8FCC
	stmdb sp!, {r3, lr}
	ldr r0, _022E8FF4 ; =ov29_02353538
	ldr r1, [r0]
	add r0, r1, #0x700
	ldrsb r0, [r0, #0x98]
	ldrb r1, [r1, #0x748]
...
_022E9104:
	...
	ldmia sp!, {r3, r4, r5, r6, r7, pc}
_022E913C:
	ldr r0, _022E91A0 ; =ov29_02353538
	mov r1, #0x1c
	ldr r0, [r0]
	ldrsh r2, [r4]
	add r0, r0, #0x2e8
...
IsPositionInSight: ; 0x022E91A4
	...
	cmp r7, #0
	bne _022E9230
	ldr r0, _022E9294 ; =ov29_02353538
	mov r1, #0x1c
	ldr r0, [r0]
	ldrsh r2, [r4]
	add r0, r0, #0x2e8
...
_022E92D0:
	...
	ldmia sp!, {r3, r4, r5, r6, r7, pc}
_022E930C:
	ldr r0, _022E9358 ; =ov29_02353538
	mov r1, #0x1c
	ldr r0, [r0]
	add r0, r0, #0x2e8
	add r0, r0, #0xec00
...
ov29_022E9488: ; 0x022E9488
	stmdb sp!, {r3, r4, r5, lr}
	ldr ip, _022E955C ; =ov29_02353538
...
GetLeader: ; 0x022E9580
	stmdb sp!, {r4, r5, r6, lr}
	ldr r0, _022E95EC ; =ov29_0235355C
	ldr r0, [r0]
	cmp r0, #0
	ldmneia sp!, {r4, r5, r6, pc}
	mov r5, #0
	ldr r4, _022E95F0 ; =ov29_02353538
	b _022E95DC
_022E95A0:
	ldr r0, [r4]
	add r0, r0, r5, lsl #2
	...
	ldrneb r0, [r0, #7]
	cmpne r0, #0
	ldrne r1, _022E95EC ; =ov29_0235355C
	movne r0, r6
	strne r6, [r1]
	ldmneia sp!, {r4, r5, r6, pc}
	add r5, r5, #1
_022E95DC:
	...
	ldmia sp!, {r4, r5, r6, pc}
	.align 2, 0
_022E95EC: .word ov29_0235355C
_022E95F0: .word ov29_02353538
