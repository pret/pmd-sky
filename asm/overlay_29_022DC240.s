...
ov29_022DE290: ; 0x022DE290
	...
	strb r2, [r0, #0xd]
	strb r2, [r0, #0xe]
	ldr r1, _022DE2C4 ; =ov29_02353538
	strb r2, [r0, #0xf]
	ldr r2, [r1]
	mov r1, #1
	add r2, r2, #0x1e0
...
ov29_022DE2C8: ; 0x022DE2C8
	...
	strb r2, [r0, #0xd]
	strb r2, [r0, #0xe]
	ldr r1, _022DE2FC ; =ov29_02353538
	strb r2, [r0, #0xf]
	ldr r1, [r1]
	add r1, r1, #0x1e0
	str r1, [r0, #0x10]
...
ov29_022DE638: ; 0x022DE638
	...
	ldr r1, _022DE844 ; =ov29_02353538
	mov r5, r0
	ldr r0, [r1]
	mov r4, #0
	add r0, r0, #0x4000
...
DungeonFree: ; 0x022DEAB0
	stmdb sp!, {r3, lr}
	ldr r0, _022DEAD8 ; =ov29_02353538
	ldr r0, [r0, #4]
	cmp r0, #0
	ldmeqia sp!, {r3, pc}
	bl MemFree
...
ov29_022DEBBC: ; 0x022DEBBC
	...
	ldr r3, _022DEF2C ; =ov29_02353538
	mov r1, #0
	ldr r2, [r3]
	sub r0, r1, #1
	strb r1, [r2, #5]
	...
	ldrb r0, [r0, #0x748]
	bl IsIqEnabled
	ldr r1, _022DEF2C ; =ov29_02353538
	ldr r2, [r1]
	strb r0, [r2, #0x12]
	ldr r0, [r1]
	ldrb r0, [r0, #0x748]
	...
	bl ov29_02338868
	bl ov29_02349188
	ldr r2, _022DEF2C ; =ov29_02353538
	mov r0, #0
	ldr r1, [r2]
	strb r0, [r1, #0x799]
	ldr r1, [r2]
	...
	strb r0, [r1, #0x791]
	bl ov29_022EAF34
	ldr r0, _022DEF2C ; =ov29_02353538
	mov r1, #0
	ldr r2, [r0]
...
_022DEE78:
	...
	bl LoadScriptVariableValue
	cmp r0, #0
	ldrne r0, _022DEF2C ; =ov29_02353538
	movne r1, #0x2b
	ldrne r0, [r0]
	addne r0, r0, #0x4000
	strneb r1, [r0, #0xda]
...
_022DEF08:
	cmp r4, #2
	ldreq r0, _022DEF2C ; =ov29_02353538
	moveq r1, #0x71
	ldreq r0, [r0]
	addeq r0, r0, #0x4000
	streqb r1, [r0, #0xda]
...
_022DEF94:
	...
	mov r1, #0x3e0
	bl DebugPrint0
	ldr r0, _022DFF40 ; =ov29_02353538
	cmp r5, #0
	str sb, [r0]
	ldrb r1, [sl]
	strb r1, [sb, #0x748]
	...
	ldrb r0, [sl]
	bl GetTurnLimit
	ldr r2, _022DFF40 ; =ov29_02353538
	mov r3, #0
	ldr r1, [r2]
	add r1, r1, #0x700
	strh r0, [r1, #0x84]
	...
	ldr r1, _022DFF40 ; =ov29_02353538
	ldr r2, [r1]
	strb r0, [r2, #0x79b]
	ldr r2, [sl, #0xac]
	ldr r0, [r1]
...
_022DF428:
	...
	bl ov29_022E1640
_022DF460:
	ldr r0, _022DFF54 ; =ov29_0235355C
	mov r1, #0
	str r1, [r0]
	bl GetDungeonGenInfoUnk0C
	mov r6, r0
...
_022DF6C0:
	...
	bl GetLeader
	cmp r0, #0
	ldrne r0, _022DFF40 ; =ov29_02353538
	movne r1, #1
	ldrne r0, [r0]
	addne r0, r0, #0x2c000
	strneb r1, [r0, #0xb10]
...
_022DFF8C:
	...
	bl GetFloorType
	cmp r0, #2
	ldreq r0, _022DFF40 ; =ov29_02353538
	ldreq r0, [r0]
	ldreqb r0, [r0, #0x758]
	cmpeq r0, #2
	bne _022DFFFC
