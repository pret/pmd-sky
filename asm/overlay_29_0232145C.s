...
ov29_02322F78: ; 0x02322F78
	...
	sub sp, sp, #0x18
	ldr r4, _023230F4 ; =ov29_02353538
	mov r7, r0
	ldr r0, [r4]
	mov r6, r1
	add r0, r0, #0x1a000
...
_0232347C:
	...
	cmp r0, #0
	beq _02323740
	ldr r0, _0232390C ; =ov29_02353538
	ldr r0, [r0]
	add r0, r0, #0x1a000
	ldrb r0, [r0, #0x23e]
	cmp r0, #0
...
_023235B4:
	...
	strh r0, [sp, #0x9c]
	ldr r0, [sp, #0x50]
	ldr r2, _0232390C ; =ov29_02353538
	sub r0, sl, r0
	mov r0, r0, asr #8
	ldr r3, [r2]
	strh r0, [sp, #0x9e]
...
_02323A6C:
	...
	cmp r0, #0
	beq _02323BB0
	ldr r0, _02323C3C ; =ov29_02353538
	ldr r0, [r0]
	add r0, r0, #0x1a000
	ldrb r0, [r0, #0x23e]
	cmp r0, #0
...
_02323B3C:
	sub r0, r8, r0
	ldr r2, _02323C3C ; =ov29_02353538
	mov r0, r0, asr #8
	strh r0, [sp, #0x2e]
	mov r0, r7, asr #8
	ldr r3, [r2]
...
_02323F18:
	mov r0, r6
	bl GetApparentWeather
	ldr r2, _02324024 ; =ov29_02353710
	ldrb r1, [r2, r0]
	cmp r1, #0
	beq _02323F44
	ldrb r1, [r2, r0]
...
_023241AC:
	...
	mov fp, #0
_023241B8:
	ldr r0, _023243B0 ; =ov29_02353538
	ldr r0, [r0]
	add r0, r0, fp, lsl #2
	add r0, r0, #0x12000
	ldr r7, [r0, #0xb78]
...
ov29_02324698: ; 0x02324698
	...
	sub sp, sp, #0x140
	mov r6, #0
	ldr fp, _02324740 ; =ov29_02353538
	mov r7, r6
	add r4, sp, #0
_023246B0:
	ldr r0, [fp]
...
_023251E8:
	...
	bl ov10_022BF1FC
	cmp r0, #0
	ldrne r0, _0232560C ; =ov29_02353538
	ldrne r0, [r0]
	addne r0, r0, #0x1a000
	ldrne r5, [r0, #0x22c]
	bne _02325228
	ldrh r0, [sb, #4]
	cmp r0, #0x52
	ldreq r0, _0232560C ; =ov29_02353538
	ldreq r0, [r0]
	addeq r0, r0, #0x1a000
	ldreq r5, [r0, #0x22c]
	movne r5, sl
_02325228:
	...
	mov r0, #7
	bl DungeonRandInt
	ldr r1, _0232560C ; =ov29_02353538
...
_023252E4:
	cmp r0, #0x76
	bne _0232531C
	ldr r2, _0232560C ; =ov29_02353538
	mov r3, #0xc
	ldr r1, [r2]
	mov r0, r5
	add r1, r1, #0x1a000
...
_0232543C:
	...
	moveq fp, #1
	beq _02325470
	ldr r0, _0232560C ; =ov29_02353538
	ldr r0, [r0]
	add r0, r0, #0x1a000
	ldr r1, [r0, #0x22c]
	cmp r1, sl
