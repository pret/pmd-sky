...
ov22_0238A79C: ; 0x0238A79C
	stmdb sp!, {lr}
	sub sp, sp, #0xc
	ldr r0, _0238A85C ; =ov22_0238EC68
	...
	str r2, [r1, #4]
	bl Arm9LoadUnkFieldNa0x2029EC8
	ldr r2, _0238A85C ; =ov22_0238EC68
...
ov22_0238A87C: ; 0x0238A87C
	stmdb sp!, {r3, lr}
	ldr r0, _0238A8F4 ; =ov22_0238EC68
	ldr r0, [r0, #4]
	cmp r0, #0
	moveq r0, #0
	ldmeqia sp!, {r3, pc}
	...
	mvn r1, #0
	cmp r0, r1
	ldrne r1, _0238A8F4 ; =ov22_0238EC68
	moveq r0, #2
	strneh r0, [r1]
	movne r0, #3
	ldmia sp!, {r3, pc}
_0238A8D0:
	...
	ldmia sp!, {r3, pc}
	.align 2, 0
_0238A8F4: .word ov22_0238EC68
	arm_func_end ov22_0238A87C

	arm_func_start ov22_0238A8F8
ov22_0238A8F8: ; 0x0238A8F8
	ldr r0, _0238A908 ; =ov22_0238EC68
	ldrsh r0, [r0]
	and r0, r0, #0xff
	bx lr
	.align 2, 0
_0238A908: .word ov22_0238EC68
...
ov22_0238A90C: ; 0x0238A90C
	...
	mov r1, #8
	bl MemAlloc
	ldr r1, _0238A93C ; =ov22_0238EC68
	str r0, [r1, #4]
	bl ov22_0238A96C
	ldr r0, _0238A93C ; =ov22_0238EC68
	mvn r1, #1
	ldr r0, [r0, #4]
	strb r1, [r0, #0x98]
	ldmia sp!, {r3, pc}
	.align 2, 0
_0238A93C: .word ov22_0238EC68
	arm_func_end ov22_0238A90C

	arm_func_start ov22_0238A940
ov22_0238A940: ; 0x0238A940
	stmdb sp!, {r3, lr}
	ldr r0, _0238A968 ; =ov22_0238EC68
	ldr r0, [r0, #4]
	cmp r0, #0
	ldmeqia sp!, {r3, pc}
	bl MemFree
...
ov22_0238A96C: ; 0x0238A96C
	...
	sub sp, sp, #0x64
	mov r3, #0
	ldr r0, _0238AB0C ; =ov22_0238EC68
	mov r2, r3
_0238A980:
	ldr r1, [r0, #4]
	add r1, r1, r3
	...
	bl sub_02010B3C
	mov sl, #0
	ldr r4, _0238AB0C ; =ov22_0238EC68
	mov r8, #3
	ldr r1, [r4, #4]
	mov r7, #1
	str r0, [r1, #0x9c]
...
ov22_0238AB18: ; 0x0238AB18
	ldr r1, _0238AB50 ; =ov22_0238EC68
	mov r0, #0
	ldr r3, [r1, #4]
	mov r2, r0
	ldr ip, [r3, #0x9c]
...
ov22_0238ABD4: ; 0x0238ABD4
	...
	and r0, r4, #0xff
	bl sub_02010B78
	ldr r0, _0238AC14 ; =ov22_0238EC68
	ldr r0, [r0, #4]
	add r0, r0, r4, lsl #2
	ldr r0, [r0, #0x210]
	rsb r0, r0, #0
...
ov22_0238AC18: ; 0x0238AC18
	...
	mov r4, #0
	mov r5, r4
	ldr r6, _0238AC88 ; =ov22_0238EC68
	b _0238AC64
_0238AC2C:
	add r0, r1, r5
	ldrb r0, [r0, #0x230]
...
ov22_0238AC8C: ; 0x0238AC8C
	...
	moveq r0, #0
	str r0, [r2]
	ldr r2, _0238ACC4 ; =ov22_0238EC68
	mov r0, #0x50
	ldr r2, [r2, #4]
	add r2, r2, #0xc8
	mla r0, r1, r0, r2
...
ov22_0238ACC8: ; 0x0238ACC8
	...
	mov r4, #0
	beq _0238AD7C
	ldr r0, _0238ADBC ; =ov22_0238EC68
	ldr r0, [r0, #4]
	ldrsb r0, [r0, #0x98]
	bl sub_0202C748
	ldr r1, _0238ADBC ; =ov22_0238EC68
	mov r5, r0
	ldr r0, [r1, #4]
	add r2, r0, #0x230
	ldrb r0, [r2, r5]
...
_0238BEA4:
	...
	bl DebugPrint0
	bl ov22_0238E7E4
	ldr r8, _0238BD60 ; =ov22_0238EC70
	mov r6, #0
	ldr r0, [r8]
	mov r4, r6
	str r6, [r0, #0x24]
...
_0238C0A0:
	...
	bl ov22_0238D528
	cmp r0, #0
	ldreq r0, _0238BD60 ; =ov22_0238EC70
	moveq r1, #0xc
	ldrne r0, _0238BD60 ; =ov22_0238EC70
	movne r1, #1
	ldr r0, [r0]
	str r1, [r0, #0x14]
	mov r0, #0
...
_0238D248:
	...
	bl DebugPrint0
	bl ov22_0238E7E4
	ldr r8, _0238D104 ; =ov22_0238EC70
	mov r6, #0
	ldr r0, [r8]
	mov r4, r6
	str r6, [r0, #0x24]
...
_0238D444:
	...
	bl ov22_0238D528
	cmp r0, #0
	ldreq r0, _0238D104 ; =ov22_0238EC70
	moveq r1, #0xc
	ldrne r0, _0238D104 ; =ov22_0238EC70
	movne r1, #1
	ldr r0, [r0]
	str r1, [r0, #0x14]
	mov r0, #0
...
ov22_0238D528: ; 0x0238D528
	stmdb sp!, {r3, lr}
	ldr r0, _0238D550 ; =ov22_0238EC70
	ldr r0, [r0]
	ldrb r0, [r0, #8]
	cmp r0, #0
	beq _0238D548
...
_0238D614:
	...
	ldr r0, _0238D63C ; =ov22_0238EC70
	ldr r1, [r0]
	ldrsb r0, [r1, #0x49]
	add r1, r1, #0x1e0
	bl ShowPortraitBox
...
ov22_0238D640: ; 0x0238D640
	...
	ldr r4, [r2]
	bl MemAlloc
	ldr r1, _0238D7A4 ; =ov22_0238EC70
	str r0, [r1]
	add r0, r0, #0x50
	bl InitPreprocessorArgs
	mov r0, #0
	bl CreateDBox
	ldr r2, _0238D7A4 ; =ov22_0238EC70
	mov r1, #3
	ldr r3, [r2]
	mov r2, #1
	strb r0, [r3, #0x48]
...
_0238D720:
	...
	strb r0, [r2, #8]
	bl ov22_0238A2C0
	ldr r0, _0238D7A4 ; =ov22_0238EC70
...
ov22_0238D7B0: ; 0x0238D7B0
	stmdb sp!, {r3, lr}
	ldr r0, _0238D7FC ; =ov22_0238EC70
	ldr r0, [r0]
	cmp r0, #0
	ldmeqia sp!, {r3, pc}
	ldrb r0, [r0, #8]
...
_0238D938:
	...
	cmp r0, #1
	ldrne r1, _0238E794 ; =ov22_0238EC70
	ldrne r1, [r1]
	strne r0, [r1, #0x38]
	cmp r0, #7
	addls pc, pc, r0, lsl #2
...
_0238DB2C:
	bne _0238DB3C
	bl ov22_0238A508
	ldr r1, _0238E794 ; =ov22_0238EC70
	b _0238DB44
_0238DB3C:
	bl ov22_0238A2AC
	ldr r1, _0238E794 ; =ov22_0238EC70
...
_0238DFC4:
	...
	bl IsBagFull
	cmp r0, #0
	ldrne r0, _0238E794 ; =ov22_0238EC70
	movne r1, #0xb
	ldrne r0, [r0]
	strne r1, [r0, #0x14]
	ldreq r0, _0238E794 ; =ov22_0238EC70
...
ov22_0238E7E4: ; 0x0238E7E4
	stmdb sp!, {r3, lr}
	ldr r0, _0238E818 ; =ov22_0238EC70
	mvn r1, #1
	ldr r0, [r0]
	ldrsb r0, [r0, #0x4c]
	cmp r0, r1
...
ov22_0238E91E:
	.byte 0x56, 0x03, 0x57, 0x03, 0x58, 0x03, 0x59, 0x03, 0x5A, 0x03, 0x5B, 0x03, 0x5C, 0x03
...
ov22_0238EC60:
	...
	.global ov22_0238EC68
ov22_0238EC68:
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.global ov22_0238EC70
ov22_0238EC70:
	.byte 0x00, 0x00, 0x00, 0x00
