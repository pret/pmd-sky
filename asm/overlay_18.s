...
ov18_0238C164: ; 0x0238C164
	...
	bl sub_02017CCC
	bl sub_0203AAB0
	ldr r1, _0238C218 ; =_0238D620
	ldr r1, [r1]
	add r1, r1, #0x300
	strh r0, [r1, #0x8c]
	bl sub_0203A5F0
	ldr r0, _0238C218 ; =_0238D620
	mov r1, #0x17
	ldr r0, [r0]
	str r1, [r0, #0x80]
	ldmia sp!, {r3, pc}
...
ov18_0238C428: ; 0x0238C428
	...
	ldr r0, _0238C474 ; =_0238D620
	mov r1, #0x1c
	ldr r0, [r0]
	str r1, [r0, #0x80]
	ldmia sp!, {r3, pc}
	.align 2, 0
_0238C474: .word _0238D620
...
ov18_0238C4A0: ; 0x0238C4A0
	stmdb sp!, {r3, lr}
	bl sub_0203FD38
	ldr r1, _0238C4E4 ; =_0238D620
	ldr r1, [r1]
	str r0, [r1, #0x3a0]
	bl sub_02041094
	ldr r2, _0238C4E4 ; =_0238D620
	mov ip, #0x400
	ldr r1, [r2]
	mov r3, #0x1e
	add r1, r1, #0x300
...
ov18_0238C9B8: ; 0x0238C9B8
	...
	bl sub_0204159C
	cmp r0, #0
	ldreq r0, _0238CA14 ; =_0238D620
	moveq r1, #0x2f
	ldreq r0, [r0]
	streq r1, [r0, #0x80]
	ldmeqia sp!, {r3, pc}
	ldr r0, _0238CA14 ; =_0238D620
	ldr r0, [r0]
	add r0, r0, #0x300
	ldrsh r0, [r0, #0x8c]
	bl ov18_0238ABB0
	cmp r0, #0
	ldrle r0, _0238CA14 ; =_0238D620
	movle r1, #0x31
	ldrle r0, [r0]
	strle r1, [r0, #0x80]
	ldrgt r0, _0238CA14 ; =_0238D620
	movgt r1, #0x33
	ldrgt r0, [r0]
	strgt r1, [r0, #0x80]
	ldmia sp!, {r3, pc}
	.align 2, 0
_0238CA14: .word _0238D620
	arm_func_end ov18_0238C9B8

	arm_func_start ov18_0238CA18
ov18_0238CA18: ; 0x0238CA18
	ldr r0, _0238CA38 ; =_0238D620
	mov r3, #3
	ldr r2, [r0]
	mov r1, #0x30
	str r3, [r2, #0x88]
...
ov18_0238CAD4: ; 0x0238CAD4
	...
	mov r0, #0
	bl GetPressedButtons
	ldr r0, _0238CBD8 ; =_0238D620
	ldr r0, [r0]
	ldrsb r0, [r0, #0xb]
	bl GetAdvancedMenuCurrentOption
	ldr r1, _0238CBD8 ; =_0238D620
	ldr r2, [r1]
	strh r0, [r2, #0x8c]
	ldrh r0, [sp]
	tst r0, #8
