...
_0230FC20: .word ov10_022C4BE4
	...
	arm_func_start ActivateEndOfTurnEffects
ActivateEndOfTurnEffects: ; 0x0230FC24
#ifdef JAPAN
...
_0231037C:
	...
	cmp r0, #0
	beq _023103F8
	ldr r0, _02310AA4 ; =SHED_SKIN_ACTIVATION_CHANCE
	ldrsh r0, [r0]
	cmp r6, r0
	bge _023103F8
	mov r0, r5
...
_0231092C:
	...
	ldr r1, _02310AD4 ; =CONSTRICTION_DAMAGE
	mov r0, r5
	ldrsh r1, [r1]
	mov r2, #2
	mov r3, #0x248
...
_02310AA4: .word SHED_SKIN_ACTIVATION_CHANCE
...
_02310AD4: .word CONSTRICTION_DAMAGE
...
_0231100C: .word 0x00000CBA + OV29_0230FC24_DATA_OFFSET
	arm_func_end ActivateEndOfTurnEffects
