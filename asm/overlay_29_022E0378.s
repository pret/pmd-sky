...
GetFloorType: ; 0x022E03B0
	stmdb sp!, {r3, lr}
	ldr r0, _022E0430 ; =ov29_02353538
	ldr r2, [r0]
	add r0, r2, #0x700
	ldrsb r0, [r0, #0x98]
	cmp r0, #2
...
ov29_022E0434: ; 0x022E0434
	...
	mov r7, #0
	ldr r4, _022E0618 ; =ov29_02353538
	mov r5, r7
	mov r6, #1
	mov fp, r7
_022E044C:
...
_022E04B4:
	...
	mov r8, #0
_022E04C4:
	ldr r0, _022E0618 ; =ov29_02353538
	ldr r0, [r0]
	add r0, r0, r8, lsl #2
	add r0, r0, #0x12000
	ldr r6, [r0, #0xb28]
	...
	ldrsh r2, [r4, #0x12]
	ldrsh r1, [r4, #0x16]
	ldr r3, _022E0618 ; =ov29_02353538
	add r1, r2, r1
	cmp r1, r0
	movgt r1, r0
	strh r1, [r4, #0x10]
...
_022E0648:
	...
	cmp r5, #0
	bne _022E0698
	ldr r1, _022E0800 ; =ov29_02353538
	mov r0, #0
	ldr r1, [r1]
	add r1, r1, #0x248
	add r1, r1, #0x400
	...
	bl DisplayMessage2
_022E0698:
	ldr r0, _022E0800 ; =ov29_02353538
	ldr r0, [r0]
	ldrb r0, [r0, #0x75f]
	cmp r0, #0
	beq _022E06B0
...
ov29_022E081C: ; 0x022E081C
	stmdb sp!, {r3, lr}
	ldr r0, _022E0860 ; =ov29_02353538
	ldr r0, [r0]
	ldrb r0, [r0, #0x748]
...
IsCurrentFixedRoomBossFight: ; 0x022E0880
	ldr r0, _022E0898 ; =ov29_02353538
...
IsMarowakTrainingMaze: ; 0x022E08A0
	ldr r0, _022E08C8 ; =ov29_02353538
	ldr r0, [r0]
	ldrb r0, [r0, #0x748]
	cmp r0, #0xb4
	blo _022E08C0
...
FadeToBlack: ; 0x022E0968
	...
	bl ov29_022E34B0
	mov r1, #1
	ldr r0, _022E09E4 ; =ov29_02353538
	ldr r0, [r0]
	add r0, r0, #0x1a000
	strb r1, [r0, #0x24d]
	ldmia sp!, {r3, pc}
	.align 2, 0
_022E09E4: .word ov29_02353538
	arm_func_end FadeToBlack

	arm_func_start ov29_022E09E8
ov29_022E09E8: ; 0x022E09E8
	ldr r2, _022E0A00 ; =ov29_02353538
	ldr r3, [r2]
	str r0, [r3, #0x18]
	ldr r0, [r2]
	strb r1, [r0, #8]
	bx lr
	.align 2, 0
_022E0A00: .word ov29_02353538
	arm_func_end ov29_022E09E8

	arm_func_start ov29_022E0A04
ov29_022E0A04: ; 0x022E0A04
	ldr r0, _022E0A14 ; =ov29_02353538
	ldr r0, [r0]
	ldr r0, [r0, #0x18]
	bx lr
	.align 2, 0
_022E0A14: .word ov29_02353538
...
ov29_022E0A18: ; 0x022E0A18
	...
	ldr r0, _022E0A60 ; =ov29_02353538
	mov r1, #1
	ldr r0, [r0]
	add r0, r0, #0x1a000
	strb r1, [r0, #0x24d]
...
_022E134C:
	...
	ldr fp, _022E14F8 ; =ov29_02353538
...
_022E13E4:
	...
	mov r0, r0, lsl #0x10
	mov r3, r0, lsr #0x10
	ldr r1, _022E14F8 ; =ov29_02353538
...
_022E1458:
	...
	blt _022E1458
	ldr r2, _022E14F4 ; =ov10_022C4D54
	ldr ip, _022E14F8 ; =ov29_02353538
...
ov29_022E150C: ; 0x022E150C
	ldr r0, _022E154C ; =ov29_02353538
	mov r3, #0
_022E1514:
	ldr r1, [r0]
	and r2, r3, #0xff
...
ov29_022E1550: ; 0x022E1550
	...
	cmp r0, #0
	bne _022E1590
	ldr r0, _022E15C4 ; =ov29_02353538
	ldr r0, [r0]
	ldrb r0, [r0, #0x748]
	bl DungeonGoesUp
	cmp r0, #0
...
_022E1590:
	cmp r0, #1
	ldrne r0, _022E15C4 ; =ov29_02353538
	movne r1, #0x1d
	ldrne r0, [r0]
	addne r0, r0, #0x4000
	strneh r1, [r0, #0xd8]
...
ov29_022E1640: ; 0x022E1640
	...
	mov r6, #0
	ldr r4, _022E1848 ; =ov29_02353538
	mov r5, r6
	mov r8, r6
	mov r7, #0xb8
_022E1658:
...
_022E1758:
	...
	cmp r6, #0xae
	blt _022E1758
	ldr r2, _022E1848 ; =ov29_02353538
	mov r0, #0
_022E1770:
	ldr r1, [r2]
	add r1, r1, r3, lsl #2
...
ov29_022E1854: ; 0x022E1854
	...
	sub sp, sp, #0xc
	ldr r4, _022E1A18 ; =ov29_02353538
	ldr r0, [r4]
	add r0, r0, #0x1a000
	ldrb r1, [r0, #0x23e]
	ldrb r8, [r0, #0x245]
