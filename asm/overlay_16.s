...
_0238A50C:
	...
	bl IsMonsterOnTeam
	cmp r0, #0
	ldrne r0, _0238B0CC ; =_0238CE40
	movne r1, #0x1a
	ldreq r0, _0238B0CC ; =_0238CE40
	moveq r1, #0x1c
	ldr r0, [r0]
	mov r4, #2
	str r1, [r0, #0x74]
...
_0238B50C:
	...
	bl IsMonsterOnTeam
	cmp r0, #0
	ldrne r0, _0238C0CC ; =_0238CE40
	movne r1, #0x1a
	ldreq r0, _0238C0CC ; =_0238CE40
	moveq r1, #0x1c
	ldr r0, [r0]
	mov r4, #2
	str r1, [r0, #0x74]
