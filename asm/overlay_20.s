	...
	arm_func_start RecycleShopEntryPointFirst
RecycleShopEntryPointFirst: ; 0x0238A140
	ldr ip, _0238A14C ; =RecycleShopCommonEntryPoint
	mov r0, #0
	bx ip
	.align 2, 0
_0238A14C: .word RecycleShopCommonEntryPoint
	arm_func_end RecycleShopEntryPointFirst

	arm_func_start RecycleShopEntryPointResume
RecycleShopEntryPointResume: ; 0x0238A150
	ldr ip, _0238A15C ; =RecycleShopCommonEntryPoint
	mov r0, #1
	bx ip
	.align 2, 0
_0238A15C: .word RecycleShopCommonEntryPoint
	arm_func_end RecycleShopEntryPointResume

	arm_func_start RecycleShopDestructor
RecycleShopDestructor: ; 0x0238A160
	stmdb sp!, {r3, lr}
	ldr r0, _0238A1AC ; =RECYCLE_SHOP_MAIN_STRUCT_PTR
	ldr r1, [r0]
	cmp r1, #0
	beq _0238A1A4
	ldr r0, [r1, #0x9c]
...
_0238A1A4:
	...
	ldmia sp!, {r3, pc}
	.align 2, 0
_0238A1AC: .word RECYCLE_SHOP_MAIN_STRUCT_PTR
	arm_func_end RecycleShopDestructor

	arm_func_start RecycleShopFrameUpdate
RecycleShopFrameUpdate: ; 0x0238A1B0
	stmdb sp!, {r3, r4, r5, r6, r7, r8, sb, sl, fp, lr}
	sub sp, sp, #0xb0
	ldr r0, _0238B144 ; =RECYCLE_SHOP_MAIN_STRUCT_PTR
	ldr r8, [r0]
	ldr r0, [r8]
	cmp r0, #8
...
_0238A210:
	...
	beq _0238B288
_0238A228:
	ldr sl, _0238B144 ; =RECYCLE_SHOP_MAIN_STRUCT_PTR
	ldr sb, [sl]
	ldr r0, [sb, #4]
	cmp r0, #9
	addls pc, pc, r0, lsl #2
...
_0238A768:
	...
	mov r1, #0x18
	bl MemZero
	bl GetRankForRecycleShop
	mov r5, r0
	bl GetGameStateRecycleCount
	mov r2, r0
	ldr r0, [sb, #0x80]
	mov r1, r5
	bl ov20_0238BB60
...
_0238A8BC:
	...
	bne _0238A8F0
	add r0, sb, #0x84
	bl RecycleShopTradeIsNonspecific
	cmp r0, #0
	movne r0, #0x13
	strne r0, [sb, #0xc]
	moveq r0, #0x1f
...
_0238A9A4:
	mov r0, sb
	mov r1, #0
	bl RecycleShopTryHidePortraitBox
	mov r0, #0x17
	str r0, [sb, #0xc]
	b _0238B05C
_0238A9BC:
...
_0238AB14:
	...
	cmp r0, #2
	bne _0238AB24
	bl ClearRecycleShopOffer
_0238AB24:
	mov r0, #1
	strb r0, [sb, #0xb0]
	bl IncrementRecycleCountVar
	ldr r1, [sb, #0x9c]
	add r0, sb, #0x84
	cmp r1, #0
	beq _0238AB48
...
_0238AB4C:
	add r0, sb, #0x84
	bl RecycleItemHasTradeTypePrizeTicket
	cmp r0, #0
	movne r0, #0x2f
	strne r0, [sb, #0xc]
	moveq r0, #0x20
...
_0238B078:
	...
	mov r0, sb
	strb r1, [sb, #0xa4]
	bl RecycleShopClosePortraitBox
	bl sub_02046D20
	mov r1, #1
	b _0238B100
_0238B09C:
...
#endif
_0238B144: .word RECYCLE_SHOP_MAIN_STRUCT_PTR
...
_0238B28C:
	...
	arm_func_end RecycleShopFrameUpdate

	arm_func_start RecycleShopCommonEntryPoint
RecycleShopCommonEntryPoint: ; 0x0238B294
	stmdb sp!, {r4, lr}
	ldr r1, _0238B33C ; =RECYCLE_SHOP_MAIN_STRUCT_PTR
	mov r4, r0
	ldr r0, [r1]
	cmp r0, #0
	bne _0238B2C8
	...
	mov r1, #8
	bl MemAlloc
	ldr r2, _0238B33C ; =RECYCLE_SHOP_MAIN_STRUCT_PTR
	mov r1, #0xb4
	str r0, [r2]
	bl MemZero
_0238B2C8:
	ldr r0, _0238B33C ; =RECYCLE_SHOP_MAIN_STRUCT_PTR
	mov r1, #0
	ldr r2, [r0]
	mvn r0, #1
	strb r0, [r2, #0x18]
	...
	ldmia sp!, {r4, pc}
	.align 2, 0
_0238B33C: .word RECYCLE_SHOP_MAIN_STRUCT_PTR
	arm_func_end RecycleShopCommonEntryPoint

	arm_func_start PrintWynautTextbox
PrintWynautTextbox: ; 0x0238B340
	stmdb sp!, {r4, lr}
	ldr r1, _0238B394 ; =RECYCLE_SHOP_MAIN_STRUCT_PTR
	mov r4, r0
	ldr r0, [r1]
	ldrb r1, [r0, #0xa4]
	cmp r1, #0
...
_0238B360:
	...
	str r2, [r1, #0x7c]
	bl StringFromId
	ldr r2, _0238B394 ; =RECYCLE_SHOP_MAIN_STRUCT_PTR
	mov r1, r0
	ldr r2, [r2]
	...
	ldmia sp!, {r4, pc}
	.align 2, 0
_0238B394: .word RECYCLE_SHOP_MAIN_STRUCT_PTR
_0238B398: .word 0x0000301C
	arm_func_end PrintWynautTextbox

	arm_func_start PrintWynautSimpleMenu
PrintWynautSimpleMenu: ; 0x0238B39C
	stmdb sp!, {r4, r5, lr}
	sub sp, sp, #0xa4
	ldrb r3, [r0, #0xa4]
	mov r5, r1
	...
	bl PrintWynautNormalPortrait
_0238B3BC:
	ldr r1, _0238B40C ; =RECYCLE_SHOP_MAIN_STRUCT_PTR
	add r0, sp, #0xc
	ldr r2, [r1]
	mov r3, #0x188
	mov r1, #0x98
	...
	ldmia sp!, {r4, r5, pc}
	.align 2, 0
_0238B40C: .word RECYCLE_SHOP_MAIN_STRUCT_PTR
	arm_func_end PrintWynautSimpleMenu

	arm_func_start RecycleShopTryHidePortraitBox
RecycleShopTryHidePortraitBox: ; 0x0238B410
	stmdb sp!, {r4, lr}
	mov r4, r0
	mov r0, #0
	str r0, [r4, #0x14]
	...
	bl sub_020125CC
	ldmia sp!, {r4, pc}
	arm_func_end RecycleShopTryHidePortraitBox
...
_0238B4A0:
	...
	arm_func_start PrintWynautNormalPortrait
PrintWynautNormalPortrait: ; 0x0238B4A8
	stmdb sp!, {r4, lr}
	mov r4, r0
	ldrsb r1, [r4, #0x18]
	mvn r0, #1
...
_0238B4D4:
	...
	strb r0, [r4, #0xa4]
	ldmia sp!, {r4, pc}
	arm_func_end PrintWynautNormalPortrait

	arm_func_start RecycleShopClosePortraitBox
RecycleShopClosePortraitBox: ; 0x0238B510
	stmdb sp!, {r4, lr}
	mov r4, r0
	ldrsb r0, [r4, #0x18]
	mvn r1, #1
	...
	strb r0, [r4, #0xa4]
	ldmia sp!, {r4, pc}
	arm_func_end RecycleShopClosePortraitBox
...
ov20_0238B540: ; 0x0238B540
	...
	mov r1, #8
	bl MemAlloc
	ldr r1, _0238B5A8 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_84H_PTR
	mov r2, #0
	str r0, [r1]
	mvn r1, #1
	strb r1, [r0, #0x14]
	...
	ldmia sp!, {r4, pc}
	.align 2, 0
_0238B5A8: .word RECYCLE_SHOP_UNK_STRUCT_SIZE_84H_PTR
	arm_func_end ov20_0238B540

	arm_func_start RecycleShopCloseAllWindows
RecycleShopCloseAllWindows: ; 0x0238B5AC
	stmdb sp!, {r3, lr}
	ldr r0, _0238B658 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_84H_PTR
	ldr r0, [r0]
	cmp r0, #0
	ldmeqia sp!, {r3, pc}
	ldrsb r0, [r0, #0x14]
...
_0238B63C:
	...
	ldmia sp!, {r3, pc}
	.align 2, 0
_0238B658: .word RECYCLE_SHOP_UNK_STRUCT_SIZE_84H_PTR
	arm_func_end RecycleShopCloseAllWindows

	arm_func_start RecycleShopHandleTopScreenWindow
RecycleShopHandleTopScreenWindow: ; 0x0238B65C
	stmdb sp!, {r4, lr}
	ldr r0, _0238B7E4 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_84H_PTR
	ldr r4, [r0]
	cmp r4, #0
	moveq r0, #0
	ldmeqia sp!, {r4, pc}
...
_0238B6E0:
	...
	ldr r1, _0238B7EC ; =RecycleShopTopScreenDrawItemStats
	mov r2, r4
	bl CreateTextBoxWithArg
	ldr r1, _0238B7E4 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_84H_PTR
	ldr r1, [r1]
	strb r0, [r1, #0x14]
_0238B70C:
	ldr r1, _0238B7E4 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_84H_PTR
	...
	ldr r1, _0238B7F4 ; =RecycleShopTopScreenDrawItemName
	mov r2, r4
	bl CreateTextBoxWithArg
	ldr r1, _0238B7E4 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_84H_PTR
	ldr r1, [r1]
...
_0238B740:
	...
	ldr r1, _0238B7FC ; =RecycleShopTopScreenDrawInfoWindow
	mov r2, r4
	bl CreateTextBoxWithArg
	ldr r1, _0238B7E4 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_84H_PTR
	ldr r1, [r1]
...
_0238B7DC:
	...
	ldmia sp!, {r4, pc}
	.align 2, 0
_0238B7E4: .word RECYCLE_SHOP_UNK_STRUCT_SIZE_84H_PTR
_0238B7E8: .word RECYCLE_WINDOW_PARAMS_2
_0238B7EC: .word RecycleShopTopScreenDrawItemStats
_0238B7F0: .word RECYCLE_WINDOW_PARAMS_1
_0238B7F4: .word RecycleShopTopScreenDrawItemName
_0238B7F8: .word RECYCLE_WINDOW_PARAMS_3
_0238B7FC: .word RecycleShopTopScreenDrawInfoWindow
	arm_func_end RecycleShopHandleTopScreenWindow

	arm_func_start ov20_0238B800
ov20_0238B800: ; 0x0238B800
	ldr r0, _0238B820 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_84H_PTR
	ldr r0, [r0]
	ldr r0, [r0]
	cmp r0, #4
	moveq r0, #1
	...
	bx lr
	.align 2, 0
_0238B820: .word RECYCLE_SHOP_UNK_STRUCT_SIZE_84H_PTR
...
_0238B898:
	...
	.align 2, 0
_0238B8C8: .word RECYCLE_SHOP_UNK_STRUCT_SIZE_84H_PTR
	arm_func_end ov20_0238B824

	arm_func_start RecycleShopTopScreenDrawItemStats
RecycleShopTopScreenDrawItemStats: ; 0x0238B8CC
	stmdb sp!, {r4, r5, r6, r7, r8, sb, sl, fp, lr}
	sub sp, sp, #0x154
	ldr r1, _0238BA30 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_84H_PTR
	mov sl, r0
	ldr r1, [r1]
	mov r8, #0
	add r7, r1, #0x6c
...
#endif
_0238BA30: .word RECYCLE_SHOP_UNK_STRUCT_SIZE_84H_PTR
_0238BA34: .word 0x00004618 + OV20_0238B8CC_OFFSET
_0238BA38: .word 0x0000461C + OV20_0238B8CC_OFFSET
_0238BA3C: .word 0x00000578
	arm_func_end RecycleShopTopScreenDrawItemStats

	arm_func_start RecycleShopTopScreenDrawItemName
RecycleShopTopScreenDrawItemName: ; 0x0238BA40
	stmdb sp!, {r4, r5, lr}
	sub sp, sp, #0x154
	ldr r1, _0238BAAC ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_84H_PTR
	mov r5, r0
	ldr r1, [r1]
	ldr r4, [r1, #0x6c]
	bl sub_02027B1C
	...
	ldmia sp!, {r4, r5, pc}
	.align 2, 0
_0238BAAC: .word RECYCLE_SHOP_UNK_STRUCT_SIZE_84H_PTR
#if defined(EUROPE)
...
#endif
	arm_func_end RecycleShopTopScreenDrawItemName

	arm_func_start RecycleShopTopScreenDrawInfoWindow
RecycleShopTopScreenDrawInfoWindow: ; 0x0238BAB4
	stmdb sp!, {r3, r4, lr}
	sub sp, sp, #0x154
	mov r4, r0
	bl sub_02027B1C
...
_0238BB5C: .word 0x0000461F + OV20_0238BAB4_OFFSET
	arm_func_end RecycleShopTopScreenDrawInfoWindow
...
ov20_0238BB60: ; 0x0238BB60
	...
	mov r1, #8
	bl MemAlloc
	ldr r1, _0238BD80 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_340H_PTR
	mvn r6, #1
	str r0, [r1]
	strb r6, [r0, #4]
	ldr r0, [r1]
	...
	strneh r1, [r0, #0x24]
_0238BC20:
	ldr r0, _0238BD80 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_340H_PTR
	mov r2, #0x10
	ldr r1, [r0]
	mov r3, #0xd
	str r2, [r1, #0x28]
	...
	ldr r2, _0238BD80 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_340H_PTR
	mov r1, #8
	ldr r3, [r2]
	str r0, [r3, #0x1c]
	ldr r0, [r2]
	...
	bl MemAlloc
	mov r7, #0
	ldr sl, _0238BD80 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_340H_PTR
	add r6, sp, #0
	ldr r1, [sl]
	mov r5, r7
	str r0, [r1, #0x33c]
...
#endif
_0238BD80: .word RECYCLE_SHOP_UNK_STRUCT_SIZE_340H_PTR
...
ov20_0238BD90: ; 0x0238BD90
	stmdb sp!, {r4, r5, lr}
	sub sp, sp, #0x5c
	ldr r1, _0238C1D0 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_340H_PTR
	ldr r4, [r1]
	ldr r0, [r4]
	cmp r0, #0xb
	addls pc, pc, r0, lsl #2
...
_0238BDE0:
	...
	strb r0, [r1, #4]
_0238BE24:
	ldr r2, _0238C1D0 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_340H_PTR
	mov r0, #0x18
	ldr r4, [r2]
	mov r1, #1
	ldr r3, [r4, #8]
	...
	ldr r0, [r0, #0x338]
	bl ov20_0238B824
	ldr r0, _0238C1D0 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_340H_PTR
	mov r1, #1
	ldr r0, [r0]
	str r1, [r0]
	b _0238C1C0
...
_0238C1B0:
	...
	bne _0238C1C8
_0238C1C0:
	bl RecycleShopHandleTopScreenWindow
	mov r0, #0
_0238C1C8:
	add sp, sp, #0x5c
	ldmia sp!, {r4, r5, pc}
	.align 2, 0
_0238C1D0: .word RECYCLE_SHOP_UNK_STRUCT_SIZE_340H_PTR
...
ov20_0238C1F0: ; 0x0238C1F0
	ldr r0, _0238C200 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_340H_PTR
	ldr r0, [r0]
	ldr r0, [r0, #0x330]
	bx lr
	.align 2, 0
_0238C200: .word RECYCLE_SHOP_UNK_STRUCT_SIZE_340H_PTR
	arm_func_end ov20_0238C1F0

	arm_func_start ov20_0238C204
ov20_0238C204: ; 0x0238C204
	stmdb sp!, {r3, lr}
	ldr r1, _0238C22C ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_340H_PTR
	mov lr, r0
	ldr r0, [r1]
	ldr ip, [r0, #0x338]
	...
	ldmia sp!, {r3, pc}
	.align 2, 0
_0238C22C: .word RECYCLE_SHOP_UNK_STRUCT_SIZE_340H_PTR
	arm_func_end ov20_0238C204

	arm_func_start ov20_0238C230
ov20_0238C230: ; 0x0238C230
	stmdb sp!, {r3, lr}
	ldr r0, _0238C284 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_340H_PTR
	ldr r0, [r0]
	cmp r0, #0
	ldmeqia sp!, {r3, pc}
	bl RecycleShopCloseAllWindows
	ldr r0, _0238C284 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_340H_PTR
	ldr r0, [r0]
	add r0, r0, #0x334
	bl FreeRecycleOfferItems
	...
	ldmia sp!, {r3, pc}
	.align 2, 0
_0238C284: .word RECYCLE_SHOP_UNK_STRUCT_SIZE_340H_PTR
...
ov20_0238C2E0: ; 0x0238C2E0
	...
	mov r1, #8
	bl MemAlloc
	ldr r2, _0238C4D8 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
	mov r1, #8
	str r0, [r2]
	str r6, [r0, #0x1bc]
	ldr r0, [r4, #4]
...
_0238C3C0:
	...
	str r1, [r2, #0x94]
	bl Arm9LoadUnkFieldNa0x2029EC8
	ldr r1, _0238C4D8 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
	ldr r2, [r1]
	str r0, [r2, #0x20]
	mov r0, #0
	ldr r5, [r1]
	...
	str r3, [r5, #0x80]
	bl ov20_0238C4E8
	ldr r0, _0238C4D8 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
	ldr r1, [r4, #4]
	ldr r0, [r0]
	mov r2, #0xa
	add r0, r0, #0xb8
	...
	.align 2, 0
_0238C4D8: .word RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
...
ov20_0238C4E8: ; 0x0238C4E8
	ldr r3, _0238C508 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
	ldr ip, [r3]
	str r0, [ip, #0x1c0]
	ldr r0, [r3]
	str r1, [r0, #0x1c4]
	...
	bx lr
	.align 2, 0
_0238C508: .word RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
...
_0238C5F0:
	...
	ldr r1, _0238C9F0 ; =DisplaySelectionTutorialWindow
	mov r2, r4
	bl CreateTextBoxWithArg
	strb r0, [r4, #8]
_0238C614:
...
_0238C650:
	...
	bl ov20_0238CB28
	cmp r0, #0
	ldreq r0, _0238C9C8 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
	moveq r1, #2
	ldreq r0, [r0]
	streq r1, [r0, #0x1b4]
	ldr r0, _0238C9C8 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
...
_0238C9C0:
	...
	ldmia sp!, {r4, r5, pc}
	.align 2, 0
_0238C9C8: .word RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
...
_0238C9F0: .word DisplaySelectionTutorialWindow
...
ov20_0238CA0C: ; 0x0238CA0C
	ldr r0, _0238CA1C ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
	ldr r0, [r0]
	ldr r0, [r0, #0x1b4]
	bx lr
	.align 2, 0
_0238CA1C: .word RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
	arm_func_end ov20_0238CA0C

	arm_func_start ov20_0238CA20
ov20_0238CA20: ; 0x0238CA20
	ldr r0, _0238CA34 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
	ldr ip, _0238CA38 ; =sub_0201255C
	ldr r0, [r0]
	ldr r0, [r0, #0x1b8]
	bx ip
	.align 2, 0
_0238CA34: .word RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
...
ov20_0238CA3C: ; 0x0238CA3C
	stmdb sp!, {r3, lr}
	ldr r0, _0238CAD4 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
	ldr ip, [r0]
	cmp ip, #0
	ldmeqia sp!, {r3, pc}
	ldr r2, [ip, #0x1b8]
...
_0238CA98:
	...
	ldmia sp!, {r3, pc}
	.align 2, 0
_0238CAD4: .word RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
...
ov20_0238CAE0: ; 0x0238CAE0
	ldr r1, _0238CB24 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
	ldr r2, [r0, #0x1b8]
	ldr r1, [r1]
	mov r0, #0
	mov ip, r0
...
_0238CB18:
	...
	bx lr
	.align 2, 0
_0238CB24: .word RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
	arm_func_end ov20_0238CAE0

	arm_func_start ov20_0238CB28
ov20_0238CB28: ; 0x0238CB28
	stmdb sp!, {r3, r4, r5, lr}
	ldr r1, _0238CB80 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
	mov r5, #0
	ldr r1, [r1]
	mov r4, r5
	ldr lr, [r1, #0x1b8]
...
_0238CB68:
	...
	ldmia sp!, {r3, r4, r5, pc}
	.align 2, 0
_0238CB80: .word RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
...
ov20_0238CC14: ; 0x0238CC14
	stmdb sp!, {r4, r5, r6, lr}
	sub sp, sp, #8
	ldr r3, _0238CCBC ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
	mov r5, r0
	ldr r0, [r3]
	mov r4, r2
	ldr r0, [r0, #0x1b8]
...
_0238CCB4:
	...
	ldmia sp!, {r4, r5, r6, pc}
	.align 2, 0
_0238CCBC: .word RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
	arm_func_end ov20_0238CC14

	arm_func_start ov20_0238CCC0
ov20_0238CCC0: ; 0x0238CCC0
	stmdb sp!, {r4, lr}
	ldr r1, _0238CD1C ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
	mov r4, r0
	ldr r0, [r1]
	bl ov20_0238CAE0
	cmp r0, #0
	...
	ldmia sp!, {r4, pc}
	.align 2, 0
_0238CD1C: .word RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
	arm_func_end ov20_0238CCC0

	arm_func_start ov20_0238CD20
ov20_0238CD20: ; 0x0238CD20
	stmdb sp!, {r3, r4, r5, lr}
	ldr r1, _0238CE38 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
	mov r4, #0
	ldr r2, [r1]
	tst r0, #0x400
	strb r4, [r2, #0x1c]
...
_0238CD98:
	...
	moveq r1, #1
	movne r1, #0
	ldr r0, _0238CE38 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
	strb r1, [r5, #6]
	ldr r0, [r0]
	ldrsb r0, [r0, #7]
	bl sub_0202F9B8
...
_0238CE30:
	...
	ldmia sp!, {r3, r4, r5, pc}
	.align 2, 0
_0238CE38: .word RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
	arm_func_end ov20_0238CD20

	arm_func_start ov20_0238CE3C
ov20_0238CE3C: ; 0x0238CE3C
	stmdb sp!, {r3, lr}
	ldr lr, _0238CE90 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
	mov ip, r0
	ldr r0, [lr]
	ldr r0, [r0, #0x1b8]
	ldr r0, [r0]
...
_0238CE80:
	...
	ldmia sp!, {r3, pc}
	.align 2, 0
_0238CE90: .word RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
#if defined(EUROPE)
...
ov20_0238CE9C: ; 0x0238CE9C
	...
	add r0, sp, #4
	bl InitPreprocessorArgs
	ldr r0, _0238CF18 ; =RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
	str r4, [sp, #0x2c]
	ldr r1, [r0]
	add r2, sp, #4
	ldr r3, [r1, #0x1bc]
	...
	ldmia sp!, {r4, r5, pc}
	.align 2, 0
_0238CF18: .word RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
#if defined(EUROPE)
...
_0238CF1C: .word 0x00004627
	...
	arm_func_start DisplaySelectionTutorialWindow
DisplaySelectionTutorialWindow: ; 0x0238CF20
	stmdb sp!, {r3, r4, lr}
	sub sp, sp, #0x154
	mov r4, r0
	bl sub_02027B1C
...
#endif
	arm_func_end DisplaySelectionTutorialWindow
	; 0x0238CF7C
...
#endif
	.word RECYCLE_SHOP_S14P02A_BGP_FILE_STR
...
RECYCLE_MAIN_MENU_ITEMS_1:
	...
	.byte 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF
	.global RECYCLE_SHOP_S14P02A_BGP_FILE_STR
...
RECYCLE_MAIN_MENU_ITEMS_3:
	...
	.data
	.global RECYCLE_SHOP_MAIN_STRUCT_PTR
RECYCLE_SHOP_MAIN_STRUCT_PTR:
	.byte 0x00, 0x00, 0x00, 0x00
	.global RECYCLE_SHOP_UNK_STRUCT_SIZE_84H_PTR
RECYCLE_SHOP_UNK_STRUCT_SIZE_84H_PTR:
	.byte 0x00, 0x00, 0x00, 0x00
	.global RECYCLE_SHOP_UNK_STRUCT_SIZE_340H_PTR
RECYCLE_SHOP_UNK_STRUCT_SIZE_340H_PTR:
	.byte 0x00, 0x00, 0x00, 0x00
	.global RECYCLE_SHOP_UNK_STRUCT_SIZE_1CCH_PTR
