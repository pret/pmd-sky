...
ov17_0238B510: ; 0x0238B510
	...
	mov r0, #5
	bl sub_02017C50
	ldr r0, _0238B530 ; =0x0238BE00
	mov r1, #0x12
	ldr r0, [r0]
	str r1, [r0, #0x78]
	ldmia sp!, {r3, pc}
	.align 2, 0
_0238B530: .word 0x0238BE00
...
ov17_0238B5DC: ; 0x0238B5DC
	stmdb sp!, {r3, lr}
	bl ov11_022DC504
	ldr r0, _0238B5F8 ; =0x0238BE00
	mov r1, #0
	ldr r0, [r0]
	str r1, [r0, #0x78]
	ldmia sp!, {r3, pc}
	.align 2, 0
_0238B5F8: .word 0x0238BE00
...
ov17_0238B688: ; 0x0238B688
	...
	mov r0, #7
	bl sub_02017C50
	ldr r0, _0238B6A8 ; =0x0238BE00
	mov r1, #0x17
	ldr r0, [r0]
	str r1, [r0, #0x78]
	ldmia sp!, {r3, pc}
	.align 2, 0
_0238B6A8: .word 0x0238BE00
...
ov17_0238B854: ; 0x0238B854
	...
	bl sub_02017C10
	cmp r0, #0
	ldreq r0, _0238B878 ; =0x0238BE00
	moveq r1, #0
	ldreq r0, [r0]
	streq r1, [r0, #0x78]
	ldmia sp!, {r3, pc}
	.align 2, 0
_0238B878: .word 0x0238BE00
	arm_func_end ov17_0238B854

	arm_func_start ov17_0238B87C
ov17_0238B87C: ; 0x0238B87C
	ldr r0, _0238B89C ; =0x0238BE00
	mov r3, #0x40
	ldr r2, [r0]
	mov r1, #0x1f
	strh r3, [r2, #0x7e]
