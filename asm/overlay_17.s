...
ov17_0238B2B4: ; 0x0238B2B4
	...
	bl sub_02017CCC
	bl sub_0203AAB0
	ldr r1, _0238B368 ; =_0238BE00
	ldr r1, [r1]
	add r1, r1, #0x200
	strh r0, [r1, #0x58]
	bl sub_0203A5F0
	ldr r0, _0238B368 ; =_0238BE00
	mov r1, #0x1e
	ldr r0, [r0]
	str r1, [r0, #0x78]
	ldmia sp!, {r3, pc}
...
ov17_0238B510: ; 0x0238B510
	...
	mov r0, #5
	bl sub_02017C50
	ldr r0, _0238B530 ; =_0238BE00
	mov r1, #0x12
	ldr r0, [r0]
	str r1, [r0, #0x78]
	ldmia sp!, {r3, pc}
	.align 2, 0
_0238B530: .word _0238BE00
...
ov17_0238B57C: ; 0x0238B57C
	...
	bl sub_02056554
	bl sub_02057444
	ldr r0, _0238B5D8 ; =_0238BE00
	mov r1, #0x14
	ldr r0, [r0]
	str r1, [r0, #0x78]
	ldmia sp!, {r3, pc}
	.align 2, 0
_0238B5D8: .word _0238BE00
...
ov17_0238B688: ; 0x0238B688
	...
	mov r0, #7
	bl sub_02017C50
	ldr r0, _0238B6A8 ; =_0238BE00
	mov r1, #0x17
	ldr r0, [r0]
	str r1, [r0, #0x78]
	ldmia sp!, {r3, pc}
	.align 2, 0
_0238B6A8: .word _0238BE00
...
ov17_0238B854: ; 0x0238B854
	...
	bl sub_02017C10
	cmp r0, #0
	ldreq r0, _0238B878 ; =_0238BE00
	moveq r1, #0
	ldreq r0, [r0]
	streq r1, [r0, #0x78]
	ldmia sp!, {r3, pc}
	.align 2, 0
_0238B878: .word _0238BE00
	arm_func_end ov17_0238B854

	arm_func_start ov17_0238B87C
ov17_0238B87C: ; 0x0238B87C
	ldr r0, _0238B89C ; =_0238BE00
	mov r3, #0x40
	ldr r2, [r0]
	mov r1, #0x1f
	strh r3, [r2, #0x7e]
...
ov17_0238B960: ; 0x0238B960
	...
	ldr r0, _0238B9AC ; =_0238BE00
	mov r1, #0x23
	ldr r0, [r0]
	str r1, [r0, #0x78]
	ldmia sp!, {r3, pc}
	.align 2, 0
_0238B9AC: .word _0238BE00
